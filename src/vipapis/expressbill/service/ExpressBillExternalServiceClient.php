...
class ExpressBillExternalServiceClient{
	...
	public static function getService(){
		...
		if (! ExpressBillExternalServiceClient::$isRegis){
			
			ExpressBillExternalServiceClient::regis ();
			ExpressBillExternalServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ExpressBillExternalServiceClient::$DEFAULT_PROXY_IP;
		$port = ExpressBillExternalServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\expressbill\service\ExpressBillExternalServiceHelper();
	}
