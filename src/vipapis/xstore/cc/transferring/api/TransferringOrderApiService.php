...
interface TransferringOrderApiServiceIf{
	...
	public function cancelOrder( $transferNo);
...
class _TransferringOrderApiServiceClient extends \Osp\Base\OspStub implements \vipapis\xstore\cc\transferring\api\TransferringOrderApiServiceIf{
	...
	public function cancelOrder( $transferNo){
		...
		$this->send_cancelOrder( $transferNo);
		return $this->recv_cancelOrder();
	}
	
	public function send_cancelOrder( $transferNo){
		
		$this->initInvocation("cancelOrder");
		$args = new \vipapis\xstore\cc\transferring\api\TransferringOrderApiService_cancelOrder_args();
		
		$args->transferNo = $transferNo;
	...
	public function recv_cancelOrder(){
		...
		$result = new \vipapis\xstore\cc\transferring\api\TransferringOrderApiService_cancelOrder_result();
...
class TransferringOrderApiService_cancelOrder_args {
...
class TransferringOrderApiService_cancelOrder_result {
