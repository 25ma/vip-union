...
interface PurchaseOrderServiceIf{
	...
	public function queryPosByCondition(\vipapis\xstore\cc\bulkbuying\api\QueryPosByConditionReq $req);
...
class _PurchaseOrderServiceClient extends \Osp\Base\OspStub implements \vipapis\xstore\cc\bulkbuying\api\PurchaseOrderServiceIf{
	...
	public function queryPosByCondition(\vipapis\xstore\cc\bulkbuying\api\QueryPosByConditionReq $req){
		...
		$this->send_queryPosByCondition( $req);
		return $this->recv_queryPosByCondition();
	}
	
	public function send_queryPosByCondition(\vipapis\xstore\cc\bulkbuying\api\QueryPosByConditionReq $req){
		
		$this->initInvocation("queryPosByCondition");
		$args = new \vipapis\xstore\cc\bulkbuying\api\PurchaseOrderService_queryPosByCondition_args();
	...
	public function recv_queryPosByCondition(){
		
		$result = new \vipapis\xstore\cc\bulkbuying\api\PurchaseOrderService_queryPosByCondition_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class PurchaseOrderService_queryPosByCondition_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \vipapis\xstore\cc\bulkbuying\api\QueryPosByConditionReq();
			$this->req->read($input);
...
class PurchaseOrderService_queryPosByCondition_result {
