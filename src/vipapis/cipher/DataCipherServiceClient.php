...
class DataCipherServiceClient{
	...
	public static function getService(){
		...
		if (! DataCipherServiceClient::$isRegis){
			
			DataCipherServiceClient::regis ();
			DataCipherServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = DataCipherServiceClient::$DEFAULT_PROXY_IP;
		$port = DataCipherServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\cipher\DataCipherServiceHelper();
	}
