...
class OrderInfo {
	...
	public $presell_refund_type = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['presell_refund_type'])){
				
				$this->presell_refund_type = $vals['presell_refund_type'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("presell_refund_type" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->presell_refund_type); 
	...
	public function write($output){
		...
		if($this->presell_refund_type !== null) {
			
			$xfer += $output->writeFieldBegin('presell_refund_type');
			$xfer += $output->writeI32($this->presell_refund_type);
