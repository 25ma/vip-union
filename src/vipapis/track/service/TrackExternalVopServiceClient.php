...
class TrackExternalVopServiceClient{
	...
	public static function getService(){
		...
		if (! TrackExternalVopServiceClient::$isRegis){
			
			TrackExternalVopServiceClient::regis ();
			TrackExternalVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TrackExternalVopServiceClient::$DEFAULT_PROXY_IP;
		$port = TrackExternalVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\track\service\TrackExternalVopServiceHelper();
	}
