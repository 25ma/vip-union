...
interface HtLoadingServiceIf{
	...
	public function receiveLoadingRelease(\com\vip\haitao\loading\osp\service\HtOrderLoadingReleaseReceiveRequest $request);
...
class _HtLoadingServiceClient extends \Osp\Base\OspStub implements \vipapis\loading\HtLoadingServiceIf{
	...
	public function receiveLoadingRelease(\com\vip\haitao\loading\osp\service\HtOrderLoadingReleaseReceiveRequest $request){
		...
		$this->send_receiveLoadingRelease( $request);
		return $this->recv_receiveLoadingRelease();
	}
	
	public function send_receiveLoadingRelease(\com\vip\haitao\loading\osp\service\HtOrderLoadingReleaseReceiveRequest $request){
		
		$this->initInvocation("receiveLoadingRelease");
		$args = new \vipapis\loading\HtLoadingService_receiveLoadingRelease_args();
	...
	public function recv_receiveLoadingRelease(){
		
		$result = new \vipapis\loading\HtLoadingService_receiveLoadingRelease_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class HtLoadingService_receiveLoadingRelease_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\haitao\loading\osp\service\HtOrderLoadingReleaseReceiveRequest();
			$this->request->read($input);
...
class HtLoadingService_receiveLoadingRelease_result {
