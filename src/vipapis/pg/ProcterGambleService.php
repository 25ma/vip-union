...
interface ProcterGambleServiceIf{
	...
	public function getBrandOrders(\vipapis\pg\BrandOrdersDetailReq $req);
	
	public function getBrandOrdersLatestDt();
...
class _ProcterGambleServiceClient extends \Osp\Base\OspStub implements \vipapis\pg\ProcterGambleServiceIf{
	...
	public function getBrandOrders(\vipapis\pg\BrandOrdersDetailReq $req){
		...
		$this->send_getBrandOrders( $req);
		return $this->recv_getBrandOrders();
	}
	
	public function send_getBrandOrders(\vipapis\pg\BrandOrdersDetailReq $req){
		
		$this->initInvocation("getBrandOrders");
		$args = new \vipapis\pg\ProcterGambleService_getBrandOrders_args();
	...
	public function recv_getBrandOrders(){
		
		$result = new \vipapis\pg\ProcterGambleService_getBrandOrders_result();
	...
	public function getBrandOrdersLatestDt(){
		...
		$this->send_getBrandOrdersLatestDt();
		return $this->recv_getBrandOrdersLatestDt();
	}
	
	public function send_getBrandOrdersLatestDt(){
		
		$this->initInvocation("getBrandOrdersLatestDt");
		$args = new \vipapis\pg\ProcterGambleService_getBrandOrdersLatestDt_args();
		
		$this->send_base($args);
	}
	
	public function recv_getBrandOrdersLatestDt(){
		
		$result = new \vipapis\pg\ProcterGambleService_getBrandOrdersLatestDt_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class ProcterGambleService_getBrandOrders_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \vipapis\pg\BrandOrdersDetailReq();
			$this->req->read($input);
...
class ProcterGambleService_getBrandOrdersLatestDt_args {
...
class ProcterGambleService_getBrandOrders_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\pg\BrandOrdersDetailResp();
...
class ProcterGambleService_getBrandOrdersLatestDt_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\pg\BrandOrdersLatestDtResp();
			$this->success->read($input);
