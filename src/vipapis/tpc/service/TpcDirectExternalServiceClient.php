...
class TpcDirectExternalServiceClient{
	...
	public static function getService(){
		...
		if (! TpcDirectExternalServiceClient::$isRegis){
			
			TpcDirectExternalServiceClient::regis ();
			TpcDirectExternalServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TpcDirectExternalServiceClient::$DEFAULT_PROXY_IP;
		$port = TpcDirectExternalServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\tpc\service\TpcDirectExternalServiceHelper();
	}
