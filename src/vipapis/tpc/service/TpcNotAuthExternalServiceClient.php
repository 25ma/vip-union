...
class TpcNotAuthExternalServiceClient{
	...
	public static function getService(){
		...
		if (! TpcNotAuthExternalServiceClient::$isRegis){
			
			TpcNotAuthExternalServiceClient::regis ();
			TpcNotAuthExternalServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TpcNotAuthExternalServiceClient::$DEFAULT_PROXY_IP;
		$port = TpcNotAuthExternalServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \vipapis\tpc\service\TpcNotAuthExternalServiceHelper();
	}
