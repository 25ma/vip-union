...
interface VendorReturnServiceIf{
	...
	public function getReturnInfo( $vendor_id, $warehouse, $return_sn, $st_create_time, $ed_create_time, $page, $limit, $origin_return_type);
...
class _VendorReturnServiceClient extends \Osp\Base\OspStub implements \vipapis\vreturn\VendorReturnServiceIf{
	...
	public function getReturnInfo( $vendor_id, $warehouse, $return_sn, $st_create_time, $ed_create_time, $page, $limit, $origin_return_type){
		...
		$this->send_getReturnInfo( $vendor_id, $warehouse, $return_sn, $st_create_time, $ed_create_time, $page, $limit, $origin_return_type);
		return $this->recv_getReturnInfo();
	}
	
	public function send_getReturnInfo( $vendor_id, $warehouse, $return_sn, $st_create_time, $ed_create_time, $page, $limit, $origin_return_type){
		...
		$args->origin_return_type = $origin_return_type;
