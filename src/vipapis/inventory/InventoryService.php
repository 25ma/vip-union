...
interface InventoryServiceIf{
	...
	public function batchGetSkuStock(\vipapis\inventory\BatchGetSkuStockRequest $batchGetSkuStockRequest);
	...
	public function getPrebuySku( $vendor_id, $barcode, $page, $limit);
...
class _InventoryServiceClient extends \Osp\Base\OspStub implements \vipapis\inventory\InventoryServiceIf{
	...
	public function batchGetSkuStock(\vipapis\inventory\BatchGetSkuStockRequest $batchGetSkuStockRequest){
		...
		$this->send_batchGetSkuStock( $batchGetSkuStockRequest);
		return $this->recv_batchGetSkuStock();
	}
	
	public function send_batchGetSkuStock(\vipapis\inventory\BatchGetSkuStockRequest $batchGetSkuStockRequest){
		
		$this->initInvocation("batchGetSkuStock");
		$args = new \vipapis\inventory\InventoryService_batchGetSkuStock_args();
		
		$args->batchGetSkuStockRequest = $batchGetSkuStockRequest;
		
		$this->send_base($args);
	}
	
	public function recv_batchGetSkuStock(){
		
		$result = new \vipapis\inventory\InventoryService_batchGetSkuStock_result();
	...
	public function getPrebuySku( $vendor_id, $barcode, $page, $limit){
		...
		$this->send_getPrebuySku( $vendor_id, $barcode, $page, $limit);
		return $this->recv_getPrebuySku();
	}
	
	public function send_getPrebuySku( $vendor_id, $barcode, $page, $limit){
		
		$this->initInvocation("getPrebuySku");
		$args = new \vipapis\inventory\InventoryService_getPrebuySku_args();
	...
	public function recv_getPrebuySku(){
		
		$result = new \vipapis\inventory\InventoryService_getPrebuySku_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class InventoryService_batchGetSkuStock_args {
	
	static $_TSPEC;
	public $batchGetSkuStockRequest = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['batchGetSkuStockRequest'])){
				
				$this->batchGetSkuStockRequest = $vals['batchGetSkuStockRequest'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$this->batchGetSkuStockRequest = new \vipapis\inventory\BatchGetSkuStockRequest();
			$this->batchGetSkuStockRequest->read($input);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('batchGetSkuStockRequest');
		
		if (!is_object($this->batchGetSkuStockRequest)) {
			
			throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
		}
		
		$xfer += $this->batchGetSkuStockRequest->write($output);
...
class InventoryService_getPrebuySku_args {
...
class InventoryService_batchGetSkuStock_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem1 = new \vipapis\inventory\UpdateInventoryResult();
					$elem1->read($input);
...
class InventoryService_getPrebuySku_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \vipapis\inventory\GetPrebuySkuResult();
			$this->success->read($input);
