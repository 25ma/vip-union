...
class CooperationNo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['jitx_subtype'])){
				
				$this->jitx_subtype = $vals['jitx_subtype'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("jitx_subtype" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->jitx_subtype);
	...
	public function write($output){
		...
		if($this->jitx_subtype !== null) {
			
			$xfer += $output->writeFieldBegin('jitx_subtype');
			$xfer += $output->writeString($this->jitx_subtype);
