...
class GetInvoicesRequest {
	...
	public $limit = null;
	public $page = null;
	public $apply_time_start = null;
	public $apply_time_end = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['apply_time_start'])){
				
				$this->apply_time_start = $vals['apply_time_start'];
			}
			
			
			if (isset($vals['apply_time_end'])){
				
				$this->apply_time_end = $vals['apply_time_end'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("apply_time_start" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->apply_time_start);
			...
			if ("apply_time_end" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->apply_time_end);
	...
	public function write($output){
		...
		if($this->apply_time_start !== null) {
			
			$xfer += $output->writeFieldBegin('apply_time_start');
			$xfer += $output->writeString($this->apply_time_start);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->apply_time_end !== null) {
			
			$xfer += $output->writeFieldBegin('apply_time_end');
			$xfer += $output->writeString($this->apply_time_end);
