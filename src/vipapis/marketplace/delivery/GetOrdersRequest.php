...
class GetOrdersRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['order_biz_flag'])){
				
				$this->order_biz_flag = $vals['order_biz_flag'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("order_biz_flag" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->order_biz_flag);
	...
	public function write($output){
		...
		if($this->order_biz_flag !== null) {
			
			$xfer += $output->writeFieldBegin('order_biz_flag');
			$xfer += $output->writeString($this->order_biz_flag);
