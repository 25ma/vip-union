...
class VipCardInfo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['activate_time'])){
				
				$this->activate_time = $vals['activate_time'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("activate_time" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->activate_time);
	...
	public function write($output){
		...
		if($this->activate_time !== null) {
			...
			$xfer += $output->writeFieldBegin('activate_time');
			$xfer += $output->writeString($this->activate_time);
