...
interface HtSaleOrderVopServiceIf{
	...
	public function getMpOrderDesensitization( $requestData);
	
	public function getSaleOrderByOrderSnList( $warehouse, $orderSnList);
	...
	public function getSaleOrdersDesensitization( $carriercode, $orderSn, $num, $customsCode);
	
	public function getSaleOrdersDesensitizationByType( $carriercode, $orderSn, $num, $customsCode, $orderType);
	...
	public function updateOrderStatus4BBC( $carrierCode, $customsCode, $orderSnList);
...
class _HtSaleOrderVopServiceClient extends \Osp\Base\OspStub implements \vipapis\orderservice\service\HtSaleOrderVopServiceIf{
	...
	public function getMpOrderDesensitization( $requestData){
		...
		$this->send_getMpOrderDesensitization( $requestData);
		return $this->recv_getMpOrderDesensitization();
	}
	
	public function send_getMpOrderDesensitization( $requestData){
		
		$this->initInvocation("getMpOrderDesensitization");
		$args = new \vipapis\orderservice\service\HtSaleOrderVopService_getMpOrderDesensitization_args();
	...
	public function recv_getMpOrderDesensitization(){
		
		$result = new \vipapis\orderservice\service\HtSaleOrderVopService_getMpOrderDesensitization_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getSaleOrderByOrderSnList( $warehouse, $orderSnList){
		...
		$this->send_getSaleOrderByOrderSnList( $warehouse, $orderSnList);
		return $this->recv_getSaleOrderByOrderSnList();
	}
	
	public function send_getSaleOrderByOrderSnList( $warehouse, $orderSnList){
		
		$this->initInvocation("getSaleOrderByOrderSnList");
		$args = new \vipapis\orderservice\service\HtSaleOrderVopService_getSaleOrderByOrderSnList_args();
	...
	public function recv_getSaleOrderByOrderSnList(){
		
		$result = new \vipapis\orderservice\service\HtSaleOrderVopService_getSaleOrderByOrderSnList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getSaleOrdersDesensitization( $carriercode, $orderSn, $num, $customsCode){
		...
		$this->send_getSaleOrdersDesensitization( $carriercode, $orderSn, $num, $customsCode);
		return $this->recv_getSaleOrdersDesensitization();
	}
	
	public function send_getSaleOrdersDesensitization( $carriercode, $orderSn, $num, $customsCode){
		
		$this->initInvocation("getSaleOrdersDesensitization");
		$args = new \vipapis\orderservice\service\HtSaleOrderVopService_getSaleOrdersDesensitization_args();
	...
	public function recv_getSaleOrdersDesensitization(){
		
		$result = new \vipapis\orderservice\service\HtSaleOrderVopService_getSaleOrdersDesensitization_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getSaleOrdersDesensitizationByType( $carriercode, $orderSn, $num, $customsCode, $orderType){
		...
		$this->send_getSaleOrdersDesensitizationByType( $carriercode, $orderSn, $num, $customsCode, $orderType);
		return $this->recv_getSaleOrdersDesensitizationByType();
	}
	
	public function send_getSaleOrdersDesensitizationByType( $carriercode, $orderSn, $num, $customsCode, $orderType){
		
		$this->initInvocation("getSaleOrdersDesensitizationByType");
		$args = new \vipapis\orderservice\service\HtSaleOrderVopService_getSaleOrdersDesensitizationByType_args();
	...
	public function recv_getSaleOrdersDesensitizationByType(){
		
		$result = new \vipapis\orderservice\service\HtSaleOrderVopService_getSaleOrdersDesensitizationByType_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function updateOrderStatus4BBC( $carrierCode, $customsCode, $orderSnList){
		...
		$this->send_updateOrderStatus4BBC( $carrierCode, $customsCode, $orderSnList);
		return $this->recv_updateOrderStatus4BBC();
	}
	
	public function send_updateOrderStatus4BBC( $carrierCode, $customsCode, $orderSnList){
		
		$this->initInvocation("updateOrderStatus4BBC");
		$args = new \vipapis\orderservice\service\HtSaleOrderVopService_updateOrderStatus4BBC_args();
	...
	public function recv_updateOrderStatus4BBC(){
		
		$result = new \vipapis\orderservice\service\HtSaleOrderVopService_updateOrderStatus4BBC_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class HtSaleOrderVopService_getMpOrderDesensitization_args {
...
class HtSaleOrderVopService_getSaleOrderByOrderSnList_args {
...
class HtSaleOrderVopService_getSaleOrdersDesensitization_args {
...
class HtSaleOrderVopService_getSaleOrdersDesensitizationByType_args {
...
class HtSaleOrderVopService_updateOrderStatus4BBC_args {
...
class HtSaleOrderVopService_getMpOrderDesensitization_result {
...
class HtSaleOrderVopService_getSaleOrderByOrderSnList_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem0 = new \com\vip\haitao\orderservice\service\HtSaleOrderResultModel();
					$elem0->read($input);
...
class HtSaleOrderVopService_getSaleOrdersDesensitization_result {
...
class HtSaleOrderVopService_getSaleOrdersDesensitizationByType_result {
...
class HtSaleOrderVopService_updateOrderStatus4BBC_result {
