...
class VopCallbackServiceClient{
	...
	public static function getService(){
		...
		if (! VopCallbackServiceClient::$isRegis){
			
			VopCallbackServiceClient::regis ();
			VopCallbackServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VopCallbackServiceClient::$DEFAULT_PROXY_IP;
		$port = VopCallbackServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vipshop\b2c\vorder\api\VopCallbackServiceHelper();
	}
