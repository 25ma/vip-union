...
class OauthFacadeClient{
	...
	public static function getService(){
		...
		if (! OauthFacadeClient::$isRegis){
			
			OauthFacadeClient::regis ();
			OauthFacadeClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OauthFacadeClient::$DEFAULT_PROXY_IP;
		$port = OauthFacadeClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\api\ubc\facade\oauth\OauthFacadeHelper();
	}
