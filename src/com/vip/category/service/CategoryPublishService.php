...
interface CategoryPublishServiceIf{
	...
	public function getCategoryExchangedReasonList(\com\vip\category\service\ReqContext $reqContext, $categoryIdList, $reasonType, $queryType);
...
class _CategoryPublishServiceClient extends \Osp\Base\OspStub implements \com\vip\category\service\CategoryPublishServiceIf{
	...
	public function getCategoryExchangedReasonList(\com\vip\category\service\ReqContext $reqContext, $categoryIdList, $reasonType, $queryType){
		...
		$this->send_getCategoryExchangedReasonList( $reqContext, $categoryIdList, $reasonType, $queryType);
		return $this->recv_getCategoryExchangedReasonList();
	}
	
	public function send_getCategoryExchangedReasonList(\com\vip\category\service\ReqContext $reqContext, $categoryIdList, $reasonType, $queryType){
		
		$this->initInvocation("getCategoryExchangedReasonList");
		$args = new \com\vip\category\service\CategoryPublishService_getCategoryExchangedReasonList_args();
	...
	public function recv_getCategoryExchangedReasonList(){
		
		$result = new \com\vip\category\service\CategoryPublishService_getCategoryExchangedReasonList_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class CategoryPublishService_getCategoryExchangedReasonList_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$names = \com\vip\category\struct\QueryReasonType::$__names;
			$name = null;
			$input->readString($name);
			foreach ($names as $k => $v){
	...
	public function write($output){
		...
		$em = new \com\vip\category\struct\QueryReasonType; 
...
class CategoryPublishService_getCategoryExchangedReasonList_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\category\struct\CategoryExchangedReasonResp();
			$this->success->read($input);
