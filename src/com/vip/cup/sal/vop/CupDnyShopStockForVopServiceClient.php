...
class CupDnyShopStockForVopServiceClient{
	...
	public static function getService(){
		...
		if (! CupDnyShopStockForVopServiceClient::$isRegis){
			
			CupDnyShopStockForVopServiceClient::regis ();
			CupDnyShopStockForVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CupDnyShopStockForVopServiceClient::$DEFAULT_PROXY_IP;
		$port = CupDnyShopStockForVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\cup\sal\vop\CupDnyShopStockForVopServiceHelper();
	}
