...
class CupShopStockForVopServiceClient{
	...
	public static function getService(){
		...
		if (! CupShopStockForVopServiceClient::$isRegis){
			
			CupShopStockForVopServiceClient::regis ();
			CupShopStockForVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CupShopStockForVopServiceClient::$DEFAULT_PROXY_IP;
		$port = CupShopStockForVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\cup\sal\vop\CupShopStockForVopServiceHelper();
	}
