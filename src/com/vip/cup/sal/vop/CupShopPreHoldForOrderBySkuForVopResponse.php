...
class CupShopPreHoldForOrderBySkuForVopResponse {
	...
	public function getName(){
		...
		return 'CupShopPreHoldForOrderBySkuForVopResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("data" == $schemeField){
				...
				$this->data = new \com\vip\cup\sal\vop\CupShopPreHoldForOrderBySkuDataForVop();
