...
class CupShopPreHoldInvForVopResult {
	...
	public function getName(){
		...
		return 'CupShopPreHoldInvForVopResult';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("optResult" == $schemeField){
				...
				$this->optResult = new \com\vip\cup\sal\vop\OptResultNewForVop();
			...
			if ("prodInvDetail" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\cup\sal\vop\CupShopProdSkuInvDetailForVop();
						$elem0->read($input);
