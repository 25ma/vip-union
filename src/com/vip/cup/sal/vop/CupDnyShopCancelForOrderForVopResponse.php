...
class CupDnyShopCancelForOrderForVopResponse {
	...
	public function getName(){
		...
		return 'CupDnyShopCancelForOrderForVopResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("data" == $schemeField){
				...
				$this->data = new \com\vip\cup\sal\vop\CupDnyShopCancelForOrderDataForVop();
