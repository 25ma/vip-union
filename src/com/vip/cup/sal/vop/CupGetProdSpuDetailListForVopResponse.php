...
class CupGetProdSpuDetailListForVopResponse {
	...
	public function getName(){
		...
		return 'CupGetProdSpuDetailListForVopResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("data" == $schemeField){
				...
				$this->data = new \com\vip\cup\sal\vop\CupGetProdSpuDetailListDataForVop();
