...
class CupSalProductForVopServiceClient{
	...
	public static function getService(){
		...
		if (! CupSalProductForVopServiceClient::$isRegis){
			
			CupSalProductForVopServiceClient::regis ();
			CupSalProductForVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CupSalProductForVopServiceClient::$DEFAULT_PROXY_IP;
		$port = CupSalProductForVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\cup\sal\vop\CupSalProductForVopServiceHelper();
	}
