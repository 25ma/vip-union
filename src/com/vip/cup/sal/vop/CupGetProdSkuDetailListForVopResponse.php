...
class CupGetProdSkuDetailListForVopResponse {
	...
	public function getName(){
		...
		return 'CupGetProdSkuDetailListForVopResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("data" == $schemeField){
				...
				$this->data = new \com\vip\cup\sal\vop\CupGetProdSkuDetailListDataForVop();
