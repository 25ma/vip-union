...
class CupDnyShopPreHoldForOrderBySkuForVopRequest {
	...
	public function getName(){
		...
		return 'CupDnyShopPreHoldForOrderBySkuForVopRequest';
	}
			...
			if ("preHoldSkuStockList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\cup\sal\vop\CupDnyShopPreHoldOrderForVop();
						$elem1->read($input);
