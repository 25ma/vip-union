...
class CupMessagePullForVopServiceClient{
	...
	public static function getService(){
		...
		if (! CupMessagePullForVopServiceClient::$isRegis){
			
			CupMessagePullForVopServiceClient::regis ();
			CupMessagePullForVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CupMessagePullForVopServiceClient::$DEFAULT_PROXY_IP;
		$port = CupMessagePullForVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\cup\sal\vop\CupMessagePullForVopServiceHelper();
	}
