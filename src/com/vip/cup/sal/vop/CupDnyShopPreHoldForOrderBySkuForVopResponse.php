...
class CupDnyShopPreHoldForOrderBySkuForVopResponse {
	...
	public function getName(){
		...
		return 'CupDnyShopPreHoldForOrderBySkuForVopResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("data" == $schemeField){
				...
				$this->data = new \com\vip\cup\sal\vop\CupDnyShopPreHoldForOrderBySkuDataForVop();
