...
class SvipBindInfo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['card_type_desc'])){
				
				$this->card_type_desc = $vals['card_type_desc'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("card_type_desc" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->card_type_desc);
	...
	public function write($output){
		...
		if($this->card_type_desc !== null) {
			
			$xfer += $output->writeFieldBegin('card_type_desc');
			$xfer += $output->writeString($this->card_type_desc);
