...
class EquityBaseInfo {
	...
	public $maxDayLimit = null;
	public $showFreeRights = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['maxDayLimit'])){
				
				$this->maxDayLimit = $vals['maxDayLimit'];
			}
			
			
			if (isset($vals['showFreeRights'])){
				
				$this->showFreeRights = $vals['showFreeRights'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("maxDayLimit" == $schemeField){
				
				$needSkip = false;
				$input->readBool($this->maxDayLimit);
			...
			if ("showFreeRights" == $schemeField){
				
				$needSkip = false;
				$input->readBool($this->showFreeRights);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('maxDayLimit');
		$xfer += $output->writeBool($this->maxDayLimit);
		
		$xfer += $output->writeFieldEnd();
		
		$xfer += $output->writeFieldBegin('showFreeRights');
		$xfer += $output->writeBool($this->showFreeRights);
