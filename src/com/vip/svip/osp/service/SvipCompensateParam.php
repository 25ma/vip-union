...
class SvipCompensateParam {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['execSource'])){
				
				$this->execSource = $vals['execSource'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("execSource" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->execSource);
	...
	public function write($output){
		...
		if($this->execSource !== null) {
			...
			$xfer += $output->writeFieldBegin('execSource');
			$xfer += $output->writeString($this->execSource);
