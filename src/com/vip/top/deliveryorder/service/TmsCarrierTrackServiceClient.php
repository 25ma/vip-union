...
class TmsCarrierTrackServiceClient{
	...
	public static function getService(){
		...
		if (! TmsCarrierTrackServiceClient::$isRegis){
			
			TmsCarrierTrackServiceClient::regis ();
			TmsCarrierTrackServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TmsCarrierTrackServiceClient::$DEFAULT_PROXY_IP;
		$port = TmsCarrierTrackServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\top\deliveryorder\service\TmsCarrierTrackServiceHelper();
	}
