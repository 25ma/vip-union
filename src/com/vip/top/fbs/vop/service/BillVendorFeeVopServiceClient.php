...
class BillVendorFeeVopServiceClient{
	...
	public static function getService(){
		...
		if (! BillVendorFeeVopServiceClient::$isRegis){
			
			BillVendorFeeVopServiceClient::regis ();
			BillVendorFeeVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = BillVendorFeeVopServiceClient::$DEFAULT_PROXY_IP;
		$port = BillVendorFeeVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\top\fbs\vop\service\BillVendorFeeVopServiceHelper();
	}
