...
class SyncResultInfo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['downCustCode'])){
				
				$this->downCustCode = $vals['downCustCode'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("downCustCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->downCustCode);
	...
	public function write($output){
		...
		if($this->downCustCode !== null) {
			
			$xfer += $output->writeFieldBegin('downCustCode');
			$xfer += $output->writeString($this->downCustCode);
