...
class TmsOrderInfoModel {
	...
	public $isCityExclusive = null;
	public $ltZpkdyTime = null;
	public $aux5 = null;
	public $carrierHold = null;
	public $isHtJitx = null;
	public $isBackToVendor = null;
	public $isVendorHold = null;
	public $extendBizMap = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['isCityExclusive'])){
				
				$this->isCityExclusive = $vals['isCityExclusive'];
			}
			
			
			if (isset($vals['ltZpkdyTime'])){
				
				$this->ltZpkdyTime = $vals['ltZpkdyTime'];
			}
			...
			if (isset($vals['carrierHold'])){
				
				$this->carrierHold = $vals['carrierHold'];
			}
			
			
			if (isset($vals['isHtJitx'])){
				
				$this->isHtJitx = $vals['isHtJitx'];
			}
			
			
			if (isset($vals['isBackToVendor'])){
				
				$this->isBackToVendor = $vals['isBackToVendor'];
			}
			
			
			if (isset($vals['isVendorHold'])){
				
				$this->isVendorHold = $vals['isVendorHold'];
			}
			
			
			if (isset($vals['extendBizMap'])){
				
				$this->extendBizMap = $vals['extendBizMap'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("isCityExclusive" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->isCityExclusive); 
			...
			if ("ltZpkdyTime" == $schemeField){
				
				$needSkip = false;
				$input->readI64($this->ltZpkdyTime);
			...
			if ("carrierHold" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->carrierHold); 
			...
			if ("isHtJitx" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->isHtJitx); 
			...
			if ("isBackToVendor" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->isBackToVendor); 
			...
			if ("isVendorHold" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->isVendorHold); 
			...
			if ("extendBizMap" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->extendBizMap);
	...
	public function write($output){
		...
		if($this->isCityExclusive !== null) {
			
			$xfer += $output->writeFieldBegin('isCityExclusive');
			$xfer += $output->writeI32($this->isCityExclusive);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->ltZpkdyTime !== null) {
			
			$xfer += $output->writeFieldBegin('ltZpkdyTime');
			$xfer += $output->writeI64($this->ltZpkdyTime);
		...
		if($this->carrierHold !== null) {
			
			$xfer += $output->writeFieldBegin('carrierHold');
			$xfer += $output->writeI32($this->carrierHold);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->isHtJitx !== null) {
			
			$xfer += $output->writeFieldBegin('isHtJitx');
			$xfer += $output->writeI32($this->isHtJitx);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->isBackToVendor !== null) {
			
			$xfer += $output->writeFieldBegin('isBackToVendor');
			$xfer += $output->writeI32($this->isBackToVendor);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->isVendorHold !== null) {
			
			$xfer += $output->writeFieldBegin('isVendorHold');
			$xfer += $output->writeByte($this->isVendorHold);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->extendBizMap !== null) {
			
			$xfer += $output->writeFieldBegin('extendBizMap');
			$xfer += $output->writeString($this->extendBizMap);
