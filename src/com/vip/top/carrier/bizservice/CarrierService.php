...
interface CarrierServiceIf{
	...
	public function getCabinetCarriersByAreaId(\com\vip\top\carrier\bizservice\GetCabinetCarriersByAreaIdRequest $request);
	...
	public function getCustStandardNameByCustStandardCode( $custStandardCode);
	
	public function getDeliveryMethod(\com\vip\top\carrier\bizservice\GetDeliveryMethodRequest $request);
	
	public function getDeliveryMethodByOrderSn(\com\vip\top\carrier\bizservice\GetDeliveryMethodByOrderSnRequest $request);
	...
	public function getSuggestVisitHourOption(\com\vip\top\carrier\bizservice\GetSuggestVisitHourOptionRequest $getSuggestVisitHourOptionRequest);
	
	public function getTransportNos(\com\vip\top\carrier\bizservice\TransportNoRequest $transportNoRequest);
	...
	public function getVisitHourOption( $returnApplyTime, $lastAddressCode, $caller);
...
class _CarrierServiceClient extends \Osp\Base\OspStub implements \com\vip\top\carrier\bizservice\CarrierServiceIf{
	...
	public function getCabinetCarriersByAreaId(\com\vip\top\carrier\bizservice\GetCabinetCarriersByAreaIdRequest $request){
		...
		$this->send_getCabinetCarriersByAreaId( $request);
		return $this->recv_getCabinetCarriersByAreaId();
	}
	
	public function send_getCabinetCarriersByAreaId(\com\vip\top\carrier\bizservice\GetCabinetCarriersByAreaIdRequest $request){
		
		$this->initInvocation("getCabinetCarriersByAreaId");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getCabinetCarriersByAreaId_args();
	...
	public function recv_getCabinetCarriersByAreaId(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getCabinetCarriersByAreaId_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getCustStandardNameByCustStandardCode( $custStandardCode){
		...
		$this->send_getCustStandardNameByCustStandardCode( $custStandardCode);
		return $this->recv_getCustStandardNameByCustStandardCode();
	}
	
	public function send_getCustStandardNameByCustStandardCode( $custStandardCode){
		
		$this->initInvocation("getCustStandardNameByCustStandardCode");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getCustStandardNameByCustStandardCode_args();
		
		$args->custStandardCode = $custStandardCode;
		
		$this->send_base($args);
	}
	
	public function recv_getCustStandardNameByCustStandardCode(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getCustStandardNameByCustStandardCode_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getDeliveryMethod(\com\vip\top\carrier\bizservice\GetDeliveryMethodRequest $request){
		...
		$this->send_getDeliveryMethod( $request);
		return $this->recv_getDeliveryMethod();
	}
	
	public function send_getDeliveryMethod(\com\vip\top\carrier\bizservice\GetDeliveryMethodRequest $request){
		
		$this->initInvocation("getDeliveryMethod");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getDeliveryMethod_args();
	...
	public function recv_getDeliveryMethod(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getDeliveryMethod_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getDeliveryMethodByOrderSn(\com\vip\top\carrier\bizservice\GetDeliveryMethodByOrderSnRequest $request){
		...
		$this->send_getDeliveryMethodByOrderSn( $request);
		return $this->recv_getDeliveryMethodByOrderSn();
	}
	
	public function send_getDeliveryMethodByOrderSn(\com\vip\top\carrier\bizservice\GetDeliveryMethodByOrderSnRequest $request){
		
		$this->initInvocation("getDeliveryMethodByOrderSn");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getDeliveryMethodByOrderSn_args();
	...
	public function recv_getDeliveryMethodByOrderSn(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getDeliveryMethodByOrderSn_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getSuggestVisitHourOption(\com\vip\top\carrier\bizservice\GetSuggestVisitHourOptionRequest $getSuggestVisitHourOptionRequest){
		...
		$this->send_getSuggestVisitHourOption( $getSuggestVisitHourOptionRequest);
		return $this->recv_getSuggestVisitHourOption();
	}
	
	public function send_getSuggestVisitHourOption(\com\vip\top\carrier\bizservice\GetSuggestVisitHourOptionRequest $getSuggestVisitHourOptionRequest){
		
		$this->initInvocation("getSuggestVisitHourOption");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getSuggestVisitHourOption_args();
		
		$args->getSuggestVisitHourOptionRequest = $getSuggestVisitHourOptionRequest;
		
		$this->send_base($args);
	}
	
	public function recv_getSuggestVisitHourOption(){
		
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getSuggestVisitHourOption_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getTransportNos(\com\vip\top\carrier\bizservice\TransportNoRequest $transportNoRequest){
		...
		$this->send_getTransportNos( $transportNoRequest);
		return $this->recv_getTransportNos();
	}
	
	public function send_getTransportNos(\com\vip\top\carrier\bizservice\TransportNoRequest $transportNoRequest){
		
		$this->initInvocation("getTransportNos");
		$args = new \com\vip\top\carrier\bizservice\CarrierService_getTransportNos_args();
		
		$args->transportNoRequest = $transportNoRequest;
	...
	public function recv_getTransportNos(){
		...
		$result = new \com\vip\top\carrier\bizservice\CarrierService_getTransportNos_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getVisitHourOption( $returnApplyTime, $lastAddressCode, $caller){
		...
		$this->send_getVisitHourOption( $returnApplyTime, $lastAddressCode, $caller);
		return $this->recv_getVisitHourOption();
	}
	
	public function send_getVisitHourOption( $returnApplyTime, $lastAddressCode, $caller){
...
class CarrierService_getCabinetCarriersByAreaId_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\top\carrier\bizservice\GetCabinetCarriersByAreaIdRequest();
...
class CarrierService_getCustStandardNameByCustStandardCode_args {
...
class CarrierService_getDeliveryMethod_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\top\carrier\bizservice\GetDeliveryMethodRequest();
			$this->request->read($input);
...
class CarrierService_getDeliveryMethodByOrderSn_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\top\carrier\bizservice\GetDeliveryMethodByOrderSnRequest();
			$this->request->read($input);
...
class CarrierService_getSuggestVisitHourOption_args {
	
	static $_TSPEC;
	public $getSuggestVisitHourOptionRequest = null;
	...
	public function __construct($vals=null){
		...
		if (!isset(self::$_TSPEC)){
			...
			self::$_TSPEC = array(
			1 => array(
			'var' => 'getSuggestVisitHourOptionRequest'
			),
		...
		if (is_array($vals)){
			...
			if (isset($vals['getSuggestVisitHourOptionRequest'])){
				
				$this->getSuggestVisitHourOptionRequest = $vals['getSuggestVisitHourOptionRequest'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$this->getSuggestVisitHourOptionRequest = new \com\vip\top\carrier\bizservice\GetSuggestVisitHourOptionRequest();
			$this->getSuggestVisitHourOptionRequest->read($input);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('getSuggestVisitHourOptionRequest');
		
		if (!is_object($this->getSuggestVisitHourOptionRequest)) {
			
			throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
		}
		
		$xfer += $this->getSuggestVisitHourOptionRequest->write($output);
...
class CarrierService_getTransportNos_args {
	
	static $_TSPEC;
	public $transportNoRequest = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['transportNoRequest'])){
				
				$this->transportNoRequest = $vals['transportNoRequest'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$this->transportNoRequest = new \com\vip\top\carrier\bizservice\TransportNoRequest();
			$this->transportNoRequest->read($input);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('transportNoRequest');
		
		if (!is_object($this->transportNoRequest)) {
			
			throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
		}
		
		$xfer += $this->transportNoRequest->write($output);
...
class CarrierService_getCabinetCarriersByAreaId_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\carrier\bizservice\GetCabinetCarriersByAreaIdResponse();
			$this->success->read($input);
...
class CarrierService_getCustStandardNameByCustStandardCode_result {
...
class CarrierService_getDeliveryMethod_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\carrier\bizservice\GetDeliveryMethodResponse();
			$this->success->read($input);
...
class CarrierService_getDeliveryMethodByOrderSn_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\carrier\bizservice\GetDeliveryMethodByOrderSnResponse();
			$this->success->read($input);
...
class CarrierService_getSuggestVisitHourOption_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\carrier\bizservice\GetSuggestVisitHourOptionResponse();
			$this->success->read($input);
...
class CarrierService_getTransportNos_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\top\carrier\bizservice\TransportNoResponse();
			$this->success->read($input);
