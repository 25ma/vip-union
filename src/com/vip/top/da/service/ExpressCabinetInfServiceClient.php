...
class ExpressCabinetInfServiceClient{
	...
	public static function getService(){
		...
		if (! ExpressCabinetInfServiceClient::$isRegis){
			
			ExpressCabinetInfServiceClient::regis ();
			ExpressCabinetInfServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ExpressCabinetInfServiceClient::$DEFAULT_PROXY_IP;
		$port = ExpressCabinetInfServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\top\da\service\ExpressCabinetInfServiceHelper();
	}
