...
class TrackLogisticExternalServiceClient{
	...
	public static function getService(){
		...
		if (! TrackLogisticExternalServiceClient::$isRegis){
			
			TrackLogisticExternalServiceClient::regis ();
			TrackLogisticExternalServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TrackLogisticExternalServiceClient::$DEFAULT_PROXY_IP;
		$port = TrackLogisticExternalServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vsc\oms\osp\carrier\track\service\TrackLogisticExternalServiceHelper();
	}
