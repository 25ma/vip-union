...
class ShipmentOuterApiServiceClient{
	...
	public static function getService(){
		...
		if (! ShipmentOuterApiServiceClient::$isRegis){
			
			ShipmentOuterApiServiceClient::regis ();
			ShipmentOuterApiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ShipmentOuterApiServiceClient::$DEFAULT_PROXY_IP;
		$port = ShipmentOuterApiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vsc\oms\osp\ship\service\ShipmentOuterApiServiceHelper();
	}
