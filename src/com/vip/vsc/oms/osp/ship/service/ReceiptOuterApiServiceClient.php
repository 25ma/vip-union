...
class ReceiptOuterApiServiceClient{
	...
	public static function getService(){
		...
		if (! ReceiptOuterApiServiceClient::$isRegis){
			
			ReceiptOuterApiServiceClient::regis ();
			ReceiptOuterApiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReceiptOuterApiServiceClient::$DEFAULT_PROXY_IP;
		$port = ReceiptOuterApiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vsc\oms\osp\ship\service\ReceiptOuterApiServiceHelper();
	}
