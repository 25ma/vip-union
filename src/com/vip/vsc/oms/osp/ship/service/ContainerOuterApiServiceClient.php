...
class ContainerOuterApiServiceClient{
	...
	public static function getService(){
		...
		if (! ContainerOuterApiServiceClient::$isRegis){
			
			ContainerOuterApiServiceClient::regis ();
			ContainerOuterApiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ContainerOuterApiServiceClient::$DEFAULT_PROXY_IP;
		$port = ContainerOuterApiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vsc\oms\osp\ship\service\ContainerOuterApiServiceHelper();
	}
