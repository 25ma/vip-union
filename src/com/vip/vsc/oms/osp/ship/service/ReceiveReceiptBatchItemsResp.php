...
class ReceiveReceiptBatchItemsResp {
	...
	public function getName(){
		...
		return 'ReceiveReceiptBatchItemsResp';
	}
			...
			if ("itemCheckInfos" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\vsc\oms\osp\ship\service\ItemCheckInfo();
						$elem0->read($input);
						
						$this->itemCheckInfos[$_size0++] = $elem0;
					}
					catch(\Exception $e){
