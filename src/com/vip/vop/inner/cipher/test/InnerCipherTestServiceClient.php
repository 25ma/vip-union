...
class InnerCipherTestServiceClient{
	...
	public static function getService(){
		...
		if (! InnerCipherTestServiceClient::$isRegis){
			
			InnerCipherTestServiceClient::regis ();
			InnerCipherTestServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = InnerCipherTestServiceClient::$DEFAULT_PROXY_IP;
		$port = InnerCipherTestServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vop\inner\cipher\test\InnerCipherTestServiceHelper();
	}
