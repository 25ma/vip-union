...
interface PoServiceShutDownIf{
	...
	public function shutDownXstorePo(\com\vip\venus\closePo\service\ShutDownPoParam $param);
...
class _PoServiceShutDownClient extends \Osp\Base\OspStub implements \com\vip\venus\closePo\service\PoServiceShutDownIf{
	...
	public function shutDownXstorePo(\com\vip\venus\closePo\service\ShutDownPoParam $param){
		...
		$this->send_shutDownXstorePo( $param);
		return $this->recv_shutDownXstorePo();
	}
	
	public function send_shutDownXstorePo(\com\vip\venus\closePo\service\ShutDownPoParam $param){
		
		$this->initInvocation("shutDownXstorePo");
		$args = new \com\vip\venus\closePo\service\PoServiceShutDown_shutDownXstorePo_args();
	...
	public function recv_shutDownXstorePo(){
		
		$result = new \com\vip\venus\closePo\service\PoServiceShutDown_shutDownXstorePo_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class PoServiceShutDown_shutDownXstorePo_args {
...
class PoServiceShutDown_shutDownXstorePo_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\vms\common\CommonResp();
			$this->success->read($input);
