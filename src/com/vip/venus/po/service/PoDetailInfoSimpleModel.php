...
class PoDetailInfoSimpleModel {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['factoryCode'])){
				
				$this->factoryCode = $vals['factoryCode'];
			}
			...
			if (isset($vals['isClearance'])){
				
				$this->isClearance = $vals['isClearance'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("factoryCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->factoryCode);
			...
			if ("isClearance" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->isClearance); 
	...
	public function write($output){
		...
		if($this->factoryCode !== null) {
			...
			$xfer += $output->writeFieldBegin('factoryCode');
			$xfer += $output->writeString($this->factoryCode);
		...
		if($this->isClearance !== null) {
			
			$xfer += $output->writeFieldBegin('isClearance');
			$xfer += $output->writeByte($this->isClearance);
