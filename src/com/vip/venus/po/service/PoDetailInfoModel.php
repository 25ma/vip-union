...
class PoDetailInfoModel {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['biwBrandType'])){
				
				$this->biwBrandType = $vals['biwBrandType'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("biwBrandType" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->biwBrandType); 
	...
	public function write($output){
		...
		if($this->biwBrandType !== null) {
			
			$xfer += $output->writeFieldBegin('biwBrandType');
			$xfer += $output->writeByte($this->biwBrandType);
