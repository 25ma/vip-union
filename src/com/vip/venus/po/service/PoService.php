...
interface PoServiceIf{
	...
	public function getOfflinePoDetail(\com\vip\venus\po\service\OfflinePoDetailReq $req);
...
class _PoServiceClient extends \Osp\Base\OspStub implements \com\vip\venus\po\service\PoServiceIf{
	...
	public function getOfflinePoDetail(\com\vip\venus\po\service\OfflinePoDetailReq $req){
		...
		$this->send_getOfflinePoDetail( $req);
		return $this->recv_getOfflinePoDetail();
	}
	
	public function send_getOfflinePoDetail(\com\vip\venus\po\service\OfflinePoDetailReq $req){
		
		$this->initInvocation("getOfflinePoDetail");
		$args = new \com\vip\venus\po\service\PoService_getOfflinePoDetail_args();
	...
	public function recv_getOfflinePoDetail(){
		
		$result = new \com\vip\venus\po\service\PoService_getOfflinePoDetail_result();
...
class PoService_getOfflinePoDetail_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\venus\po\service\OfflinePoDetailReq();
			$this->req->read($input);
...
class PoService_getOfflinePoDetail_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\venus\po\service\OfflinePoDetailResp();
