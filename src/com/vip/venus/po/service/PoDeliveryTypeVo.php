...
class PoDeliveryTypeVo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['schedule_code'])){
				
				$this->schedule_code = $vals['schedule_code'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("schedule_code" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->schedule_code);
	...
	public function write($output){
		...
		if($this->schedule_code !== null) {
			
			$xfer += $output->writeFieldBegin('schedule_code');
			$xfer += $output->writeString($this->schedule_code);
