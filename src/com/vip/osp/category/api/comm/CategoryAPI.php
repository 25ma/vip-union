...
interface CategoryAPIIf{
	...
	public function batchGetQualifications(\com\vip\osp\category\api\comm\ReqContext $reqContext, $qualificationIds);
	...
	public function getExchangedReasonByCategoryId( $categoryId, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId);
	
	public function getExchangedReasonListByCategoryIds( $categoryIdSet, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId);
...
class _CategoryAPIClient extends \Osp\Base\OspStub implements \com\vip\osp\category\api\comm\CategoryAPIIf{
	...
	public function batchGetQualifications(\com\vip\osp\category\api\comm\ReqContext $reqContext, $qualificationIds){
		...
		$this->send_batchGetQualifications( $reqContext, $qualificationIds);
		return $this->recv_batchGetQualifications();
	}
	
	public function send_batchGetQualifications(\com\vip\osp\category\api\comm\ReqContext $reqContext, $qualificationIds){
		
		$this->initInvocation("batchGetQualifications");
		$args = new \com\vip\osp\category\api\comm\CategoryAPI_batchGetQualifications_args();
		
		$args->reqContext = $reqContext;
		
		$args->qualificationIds = $qualificationIds;
		
		$this->send_base($args);
	}
	
	public function recv_batchGetQualifications(){
		
		$result = new \com\vip\osp\category\api\comm\CategoryAPI_batchGetQualifications_result();
	...
	public function getExchangedReasonByCategoryId( $categoryId, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId){
		...
		$this->send_getExchangedReasonByCategoryId( $categoryId, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId);
		return $this->recv_getExchangedReasonByCategoryId();
	}
	
	public function send_getExchangedReasonByCategoryId( $categoryId, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId){
	...
	public function getExchangedReasonListByCategoryIds( $categoryIdSet, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId){
		...
		$this->send_getExchangedReasonListByCategoryIds( $categoryIdSet, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId);
		return $this->recv_getExchangedReasonListByCategoryIds();
	}
	
	public function send_getExchangedReasonListByCategoryIds( $categoryIdSet, $reasonType, $isShow, $appId, $flagsMap, $hierarchy, $parentId){
...
class CategoryAPI_batchGetQualifications_args {
	
	static $_TSPEC;
	public $reqContext = null;
	public $qualificationIds = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['qualificationIds'])){
				
				$this->qualificationIds = $vals['qualificationIds'];
			}
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$this->qualificationIds[$_size0++] = $elem0;
				}
				catch(\Exception $e){
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('qualificationIds');
		
		if (!is_array($this->qualificationIds)){
			
			throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
		}
		
		$output->writeListBegin();
		foreach ($this->qualificationIds as $iter0){
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$this->categoryIdSet[$_size0++] = $elem0;
				}
				catch(\Exception $e){
...
class CategoryAPI_batchGetQualifications_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$val1 = new \com\vip\osp\category\api\comm\Qualification();
					$val1->read($input);
