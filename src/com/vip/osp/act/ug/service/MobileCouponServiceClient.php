...
class MobileCouponServiceClient{
	...
	public static function getService(){
		...
		if (! MobileCouponServiceClient::$isRegis){
			
			MobileCouponServiceClient::regis ();
			MobileCouponServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = MobileCouponServiceClient::$DEFAULT_PROXY_IP;
		$port = MobileCouponServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\osp\act\ug\service\MobileCouponServiceHelper();
	}
