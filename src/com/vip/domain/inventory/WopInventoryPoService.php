...
class _WopInventoryPoServiceClient extends \Osp\Base\OspStub implements \com\vip\domain\inventory\WopInventoryPoServiceIf{
	
	public function __construct(){
		
		parent::__construct("com.vip.domain.inventory.WopInventoryPoService", "1.0.0");
	}
	...
	public function send_cancelPo( $vendor_id, $systemPoNo){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_cancelPo_args();
	...
	public function recv_cancelPo(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_cancelPo_result();
	...
	public function send_cleanPoDetail( $vendor_id, $systemPoNo){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_cleanPoDetail_args();
	...
	public function recv_cleanPoDetail(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_cleanPoDetail_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_createPo( $vendor_id,\com\vip\domain\inventory\CreatePoRequest $poReq){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_createPo_args();
	...
	public function recv_createPo(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_createPo_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_editPO( $vendor_id,\com\vip\domain\inventory\EditPoRequest $poReq){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_editPO_args();
	...
	public function recv_editPO(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_editPO_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_getPoDetailList( $vendor_id, $systemPoNo, $pageNum, $pageSize){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_getPoDetailList_args();
	...
	public function recv_getPoDetailList(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_getPoDetailList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_healthCheck(){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_healthCheck_args();
	...
	public function recv_healthCheck(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_healthCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_importPoDetail( $vendor_id, $systemPoNo, $impSkuList){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_importPoDetail_args();
	...
	public function recv_importPoDetail(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_importPoDetail_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_searchPoList( $vendor_id, $pageNum, $pageSize,\com\vip\domain\inventory\SearchPoRequest $searchRequest){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_searchPoList_args();
	...
	public function recv_searchPoList(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_searchPoList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_submitPo( $vendor_id, $systemPoNo){
		...
		$args = new \com\vip\domain\inventory\WopInventoryPoService_submitPo_args();
	...
	public function recv_submitPo(){
		...
		$result = new \com\vip\domain\inventory\WopInventoryPoService_submitPo_result();
		$this->receive_base($result);
		if ($result->success !== null){
