...
class ShopVopServiceClient{
	...
	public static function getService(){
		...
		if (! ShopVopServiceClient::$isRegis){
			
			ShopVopServiceClient::regis ();
			ShopVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ShopVopServiceClient::$DEFAULT_PROXY_IP;
		$port = ShopVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\mapi\shop\service\vop\ShopVopServiceHelper();
	}
