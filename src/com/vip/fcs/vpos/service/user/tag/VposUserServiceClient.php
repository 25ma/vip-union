...
class VposUserServiceClient{
	...
	public static function getService(){
		...
		if (! VposUserServiceClient::$isRegis){
			
			VposUserServiceClient::regis ();
			VposUserServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VposUserServiceClient::$DEFAULT_PROXY_IP;
		$port = VposUserServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\vpos\service\user\tag\VposUserServiceHelper();
	}
