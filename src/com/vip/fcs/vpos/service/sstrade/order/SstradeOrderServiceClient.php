...
class SstradeOrderServiceClient{
	...
	public static function getService(){
		...
		if (! SstradeOrderServiceClient::$isRegis){
			
			SstradeOrderServiceClient::regis ();
			SstradeOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SstradeOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = SstradeOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\vpos\service\sstrade\order\SstradeOrderServiceHelper();
	}
