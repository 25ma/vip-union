...
class GuideShareServiceClient{
	...
	public static function getService(){
		...
		if (! GuideShareServiceClient::$isRegis){
			
			GuideShareServiceClient::regis ();
			GuideShareServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = GuideShareServiceClient::$DEFAULT_PROXY_IP;
		$port = GuideShareServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\vpos\service\guide\GuideShareServiceHelper();
	}
