...
class VposTokenServiceClient{
	...
	public static function getService(){
		...
		if (! VposTokenServiceClient::$isRegis){
			
			VposTokenServiceClient::regis ();
			VposTokenServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VposTokenServiceClient::$DEFAULT_PROXY_IP;
		$port = VposTokenServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\vpos\service\vip\VposTokenServiceHelper();
	}
