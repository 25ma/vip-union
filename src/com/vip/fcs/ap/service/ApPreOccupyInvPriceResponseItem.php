...
class ApPreOccupyInvPriceResponseItem {
	...
	public function getName(){
		...
		return 'ApPreOccupyInvPriceResponseItem';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("req" == $schemeField){
				...
				$this->req = new \com\vip\fcs\ap\service\ApPreOccupyInvPriceRequestItem();
				$this->req->read($input);
			...
			if ("details" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\fcs\ap\service\ApPreOccupyInvPriceResponseDetail();
						$elem0->read($input);
