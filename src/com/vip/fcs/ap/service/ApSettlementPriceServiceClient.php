...
class ApSettlementPriceServiceClient{
	...
	public static function getService(){
		...
		if (! ApSettlementPriceServiceClient::$isRegis){
			
			ApSettlementPriceServiceClient::regis ();
			ApSettlementPriceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ApSettlementPriceServiceClient::$DEFAULT_PROXY_IP;
		$port = ApSettlementPriceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\ap\service\ApSettlementPriceServiceHelper();
	}
