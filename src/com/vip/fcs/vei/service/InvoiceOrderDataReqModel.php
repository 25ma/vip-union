...
class InvoiceOrderDataReqModel {
	...
	public $customerTelEncrypt = null;
	...
	public $memberEmailEncrypt = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['customerTelEncrypt'])){
				
				$this->customerTelEncrypt = $vals['customerTelEncrypt'];
			}
			...
			if (isset($vals['memberEmailEncrypt'])){
				
				$this->memberEmailEncrypt = $vals['memberEmailEncrypt'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("customerTelEncrypt" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->customerTelEncrypt);
			...
			if ("memberEmailEncrypt" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->memberEmailEncrypt);
	...
	public function write($output){
		...
		if($this->customerTelEncrypt !== null) {
			
			$xfer += $output->writeFieldBegin('customerTelEncrypt');
			$xfer += $output->writeString($this->customerTelEncrypt);
		...
		if($this->memberEmailEncrypt !== null) {
			
			$xfer += $output->writeFieldBegin('memberEmailEncrypt');
			$xfer += $output->writeString($this->memberEmailEncrypt);
