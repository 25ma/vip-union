...
class RbpFnSsSpecialItemRecordOspServiceClient{
	...
	public static function getService(){
		...
		if (! RbpFnSsSpecialItemRecordOspServiceClient::$isRegis){
			
			RbpFnSsSpecialItemRecordOspServiceClient::regis ();
			RbpFnSsSpecialItemRecordOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RbpFnSsSpecialItemRecordOspServiceClient::$DEFAULT_PROXY_IP;
		$port = RbpFnSsSpecialItemRecordOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\app\rbp\fin\service\RbpFnSsSpecialItemRecordOspServiceHelper();
	}
