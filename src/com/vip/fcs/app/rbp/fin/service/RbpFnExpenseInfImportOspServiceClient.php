...
class RbpFnExpenseInfImportOspServiceClient{
	...
	public static function getService(){
		...
		if (! RbpFnExpenseInfImportOspServiceClient::$isRegis){
			
			RbpFnExpenseInfImportOspServiceClient::regis ();
			RbpFnExpenseInfImportOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RbpFnExpenseInfImportOspServiceClient::$DEFAULT_PROXY_IP;
		$port = RbpFnExpenseInfImportOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\app\rbp\fin\service\RbpFnExpenseInfImportOspServiceHelper();
	}
