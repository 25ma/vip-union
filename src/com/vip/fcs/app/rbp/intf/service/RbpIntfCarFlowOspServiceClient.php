...
class RbpIntfCarFlowOspServiceClient{
	...
	public static function getService(){
		...
		if (! RbpIntfCarFlowOspServiceClient::$isRegis){
			
			RbpIntfCarFlowOspServiceClient::regis ();
			RbpIntfCarFlowOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RbpIntfCarFlowOspServiceClient::$DEFAULT_PROXY_IP;
		$port = RbpIntfCarFlowOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\app\rbp\intf\service\RbpIntfCarFlowOspServiceHelper();
	}
