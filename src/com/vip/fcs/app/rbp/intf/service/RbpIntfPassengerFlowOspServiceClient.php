...
class RbpIntfPassengerFlowOspServiceClient{
	...
	public static function getService(){
		...
		if (! RbpIntfPassengerFlowOspServiceClient::$isRegis){
			
			RbpIntfPassengerFlowOspServiceClient::regis ();
			RbpIntfPassengerFlowOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = RbpIntfPassengerFlowOspServiceClient::$DEFAULT_PROXY_IP;
		$port = RbpIntfPassengerFlowOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\app\rbp\intf\service\RbpIntfPassengerFlowOspServiceHelper();
	}
