...
class ArIntTrxhInOspServiceClient{
	...
	public static function getService(){
		...
		if (! ArIntTrxhInOspServiceClient::$isRegis){
			
			ArIntTrxhInOspServiceClient::regis ();
			ArIntTrxhInOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ArIntTrxhInOspServiceClient::$DEFAULT_PROXY_IP;
		$port = ArIntTrxhInOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ar\intfc\service\ArIntTrxhInOspServiceHelper();
	}
