...
class ArIntRecReturnInOspServiceClient{
	...
	public static function getService(){
		...
		if (! ArIntRecReturnInOspServiceClient::$isRegis){
			
			ArIntRecReturnInOspServiceClient::regis ();
			ArIntRecReturnInOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ArIntRecReturnInOspServiceClient::$DEFAULT_PROXY_IP;
		$port = ArIntRecReturnInOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ar\intfc\service\ArIntRecReturnInOspServiceHelper();
	}
