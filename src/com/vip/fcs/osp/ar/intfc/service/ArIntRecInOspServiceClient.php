...
class ArIntRecInOspServiceClient{
	...
	public static function getService(){
		...
		if (! ArIntRecInOspServiceClient::$isRegis){
			
			ArIntRecInOspServiceClient::regis ();
			ArIntRecInOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ArIntRecInOspServiceClient::$DEFAULT_PROXY_IP;
		$port = ArIntRecInOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ar\intfc\service\ArIntRecInOspServiceHelper();
	}
