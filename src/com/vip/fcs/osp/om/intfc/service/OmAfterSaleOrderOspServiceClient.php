...
class OmAfterSaleOrderOspServiceClient{
	...
	public static function getService(){
		...
		if (! OmAfterSaleOrderOspServiceClient::$isRegis){
			
			OmAfterSaleOrderOspServiceClient::regis ();
			OmAfterSaleOrderOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OmAfterSaleOrderOspServiceClient::$DEFAULT_PROXY_IP;
		$port = OmAfterSaleOrderOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\om\intfc\service\OmAfterSaleOrderOspServiceHelper();
	}
