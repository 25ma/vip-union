...
class OmPreSaleOrderOspServiceClient{
	...
	public static function getService(){
		...
		if (! OmPreSaleOrderOspServiceClient::$isRegis){
			
			OmPreSaleOrderOspServiceClient::regis ();
			OmPreSaleOrderOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OmPreSaleOrderOspServiceClient::$DEFAULT_PROXY_IP;
		$port = OmPreSaleOrderOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\om\intfc\service\OmPreSaleOrderOspServiceHelper();
	}
