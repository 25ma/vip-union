	...
	public function read($input){
		...
		while(true){
			...
			if ("orderIn" == $schemeField){
				...
				$this->orderIn = new \com\vip\fcs\osp\om\intfc\service\OmIntOrderReturnInModel();
			...
			if ("orderItemList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\fcs\osp\om\intfc\service\OmIntOrderItemReturnInModel();
						$elem0->read($input);
			...
			if ("orderactiveList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\fcs\osp\om\intfc\service\OmIntOrderActiveReturnInModel();
						$elem1->read($input);
			...
			if ("orderPayList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem2 = new \com\vip\fcs\osp\om\intfc\service\OmIntOrderPayReturnInModel();
						$elem2->read($input);
