...
class VoucherLineModel {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['context3'])){
				
				$this->context3 = $vals['context3'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("context3" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->context3);
	...
	public function write($output){
		...
		if($this->context3 !== null) {
			...
			$xfer += $output->writeFieldBegin('context3');
			$xfer += $output->writeString($this->context3);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->glSlLinkId !== null) {
