...
class CuxGlPeriodCheckCloseServiceClient{
	...
	public static function getService(){
		...
		if (! CuxGlPeriodCheckCloseServiceClient::$isRegis){
			
			CuxGlPeriodCheckCloseServiceClient::regis ();
			CuxGlPeriodCheckCloseServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CuxGlPeriodCheckCloseServiceClient::$DEFAULT_PROXY_IP;
		$port = CuxGlPeriodCheckCloseServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ebs\gl\service\CuxGlPeriodCheckCloseServiceHelper();
	}
