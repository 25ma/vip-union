...
class CuxGlPeriodBalancesServiceClient{
	...
	public static function getService(){
		...
		if (! CuxGlPeriodBalancesServiceClient::$isRegis){
			
			CuxGlPeriodBalancesServiceClient::regis ();
			CuxGlPeriodBalancesServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = CuxGlPeriodBalancesServiceClient::$DEFAULT_PROXY_IP;
		$port = CuxGlPeriodBalancesServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\fcs\osp\ebs\gl\service\CuxGlPeriodBalancesServiceHelper();
	}
