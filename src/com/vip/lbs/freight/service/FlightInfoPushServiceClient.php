...
class FlightInfoPushServiceClient{
	...
	public static function getService(){
		...
		if (! FlightInfoPushServiceClient::$isRegis){
			
			FlightInfoPushServiceClient::regis ();
			FlightInfoPushServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = FlightInfoPushServiceClient::$DEFAULT_PROXY_IP;
		$port = FlightInfoPushServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\lbs\freight\service\FlightInfoPushServiceHelper();
	}
