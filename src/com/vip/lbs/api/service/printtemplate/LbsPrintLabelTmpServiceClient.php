...
class LbsPrintLabelTmpServiceClient{
	...
	public static function getService(){
		...
		if (! LbsPrintLabelTmpServiceClient::$isRegis){
			
			LbsPrintLabelTmpServiceClient::regis ();
			LbsPrintLabelTmpServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = LbsPrintLabelTmpServiceClient::$DEFAULT_PROXY_IP;
		$port = LbsPrintLabelTmpServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\lbs\api\service\printtemplate\LbsPrintLabelTmpServiceHelper();
	}
