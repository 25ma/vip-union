...
class LbsGetPrintTemplateInfoResponse {
	...
	public function getName(){
		...
		return 'LbsGetPrintTemplateInfoResponse';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("model" == $schemeField){
				...
				$this->model = new \com\vip\lbs\api\service\printtemplate\PrintTemplateInfoModel();
