...
class LbsGetPrintTemplateInfoListResponse {
	...
	public function getName(){
		...
		return 'LbsGetPrintTemplateInfoListResponse';
	}
			...
			if ("modelList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\lbs\api\service\printtemplate\PrintTemplateInfoModel();
						$elem1->read($input);
