...
class WorkflowShipResetServiceClient{
	...
	public static function getService(){
		...
		if (! WorkflowShipResetServiceClient::$isRegis){
			
			WorkflowShipResetServiceClient::regis ();
			WorkflowShipResetServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WorkflowShipResetServiceClient::$DEFAULT_PROXY_IP;
		$port = WorkflowShipResetServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\workflow\service\shipReset\WorkflowShipResetServiceHelper();
	}
