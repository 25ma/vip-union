...
class GetShipResetWorkflowVopRequest {
	
	static $_TSPEC;
	public $vendor_id = null;
	public $workflow_sn_list = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['workflow_sn_list'])){
				
				$this->workflow_sn_list = $vals['workflow_sn_list'];
			}
	...
	public function getName(){
		...
		return 'GetShipResetWorkflowVopRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("workflow_sn_list" == $schemeField){
				
				$needSkip = false;
				
				$this->workflow_sn_list = array();
				$_size1 = 0;
				$input->readListBegin();
				while(true){
					...
					try{
						...
						$this->workflow_sn_list[$_size1++] = $elem1;
					}
					catch(\Exception $e){
			...
			if ("order_sn_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->order_sn_list[$_size2++] = $elem2;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->workflow_sn_list !== null) {
			
			$xfer += $output->writeFieldBegin('workflow_sn_list');
			
			if (!is_array($this->workflow_sn_list)){
				
				throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
			}
			
			$output->writeListBegin();
			foreach ($this->workflow_sn_list as $iter0){
