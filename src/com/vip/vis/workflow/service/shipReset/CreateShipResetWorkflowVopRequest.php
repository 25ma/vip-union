...
class CreateShipResetWorkflowVopRequest {
	...
	public function getName(){
		...
		return 'CreateShipResetWorkflowVopRequest';
	}
			...
			if ("workflows" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\vis\workflow\service\shipReset\ShipResetWorkflowVopItem();
						$elem0->read($input);
