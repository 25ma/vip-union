...
class CreateShipResetWorkflowResult {
	...
	public function getName(){
		...
		return 'CreateShipResetWorkflowResult';
	}
			...
			if ("workflows" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\vis\workflow\service\shipReset\CreateShipResetWorkflowResp();
						$elem1->read($input);
						
						$this->workflows[$_size1++] = $elem1;
					}
					catch(\Exception $e){
