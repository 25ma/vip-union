...
class WorkflowJitXCustomizeServiceClient{
	...
	public static function getService(){
		...
		if (! WorkflowJitXCustomizeServiceClient::$isRegis){
			
			WorkflowJitXCustomizeServiceClient::regis ();
			WorkflowJitXCustomizeServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WorkflowJitXCustomizeServiceClient::$DEFAULT_PROXY_IP;
		$port = WorkflowJitXCustomizeServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\workflow\service\WorkflowJitXCustomizeServiceHelper();
	}
