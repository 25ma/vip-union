...
class ProblemOrderAbnormalReportServiceForVopClient{
	...
	public static function getService(){
		...
		if (! ProblemOrderAbnormalReportServiceForVopClient::$isRegis){
			
			ProblemOrderAbnormalReportServiceForVopClient::regis ();
			ProblemOrderAbnormalReportServiceForVopClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ProblemOrderAbnormalReportServiceForVopClient::$DEFAULT_PROXY_IP;
		$port = ProblemOrderAbnormalReportServiceForVopClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\problemorder\service\ProblemOrderAbnormalReportServiceForVopHelper();
	}
