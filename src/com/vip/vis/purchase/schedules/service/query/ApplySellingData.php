...
class ApplySellingData {
	...
	public $releaseSellTime = null;
	public $jitxSubtype = null;
	public $virtualToRi = null;
	public $clearanceToRi = null;
	public $warehouseType = null;
	public $settlementMethodGroup = null;
	public $isOnlyBlackProduct = null;
	public $poCopyFlag = null;
	...
	public function __construct($vals=null){
		...
		if (!isset(self::$_TSPEC)){
			...
			68 => array(
			'var' => 'settlementMethodGroup'
			),
			69 => array(
			'var' => 'isOnlyBlackProduct'
			),
			70 => array(
			'var' => 'poCopyFlag'
			),
		...
		if (is_array($vals)){
			...
			if (isset($vals['releaseSellTime'])){
				
				$this->releaseSellTime = $vals['releaseSellTime'];
			}
			
			
			if (isset($vals['jitxSubtype'])){
				
				$this->jitxSubtype = $vals['jitxSubtype'];
			}
			
			
			if (isset($vals['virtualToRi'])){
				
				$this->virtualToRi = $vals['virtualToRi'];
			}
			
			
			if (isset($vals['clearanceToRi'])){
				
				$this->clearanceToRi = $vals['clearanceToRi'];
			}
			...
			if (isset($vals['settlementMethodGroup'])){
				
				$this->settlementMethodGroup = $vals['settlementMethodGroup'];
			}
			
			
			if (isset($vals['isOnlyBlackProduct'])){
				
				$this->isOnlyBlackProduct = $vals['isOnlyBlackProduct'];
			}
			
			
			if (isset($vals['poCopyFlag'])){
				
				$this->poCopyFlag = $vals['poCopyFlag'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("releaseSellTime" == $schemeField){
				
				$needSkip = false;
				$input->readI64($this->releaseSellTime);
			...
			if ("jitxSubtype" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->jitxSubtype);
			...
			if ("virtualToRi" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->virtualToRi);
			...
			if ("clearanceToRi" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->clearanceToRi);
			...
			if ("settlementMethodGroup" == $schemeField){
				
				$needSkip = false;
				
				$names = \com\vip\vis\purchase\schedules\service\create\SettlementMethodGroupEnum::$__names;
				$name = null;
			...
			if ("isOnlyBlackProduct" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->isOnlyBlackProduct);
			...
			if ("poCopyFlag" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->poCopyFlag); 
	...
	public function write($output){
		...
		if($this->releaseSellTime !== null) {
			
			$xfer += $output->writeFieldBegin('releaseSellTime');
			$xfer += $output->writeI64($this->releaseSellTime);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->jitxSubtype !== null) {
			
			$xfer += $output->writeFieldBegin('jitxSubtype');
			$xfer += $output->writeString($this->jitxSubtype);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->virtualToRi !== null) {
			
			$xfer += $output->writeFieldBegin('virtualToRi');
			$xfer += $output->writeString($this->virtualToRi);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->clearanceToRi !== null) {
			
			$xfer += $output->writeFieldBegin('clearanceToRi');
			$xfer += $output->writeString($this->clearanceToRi);
		...
		if($this->settlementMethodGroup !== null) {
			
			$xfer += $output->writeFieldBegin('settlementMethodGroup');
			
			$em = new \com\vip\vis\purchase\schedules\service\create\SettlementMethodGroupEnum; 
			$output->writeString($em::$__names[$this->settlementMethodGroup]);  
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->isOnlyBlackProduct !== null) {
			
			$xfer += $output->writeFieldBegin('isOnlyBlackProduct');
			$xfer += $output->writeString($this->isOnlyBlackProduct);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->poCopyFlag !== null) {
			
			$xfer += $output->writeFieldBegin('poCopyFlag');
			$xfer += $output->writeByte($this->poCopyFlag);
