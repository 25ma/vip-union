...
class ApplySellingSimpleData {
	...
	public $stockMultiWarehouse = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['stockMultiWarehouse'])){
				
				$this->stockMultiWarehouse = $vals['stockMultiWarehouse'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("stockMultiWarehouse" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->stockMultiWarehouse); 
	...
	public function write($output){
		...
		if($this->stockMultiWarehouse !== null) {
			
			$xfer += $output->writeFieldBegin('stockMultiWarehouse');
			$xfer += $output->writeByte($this->stockMultiWarehouse);
