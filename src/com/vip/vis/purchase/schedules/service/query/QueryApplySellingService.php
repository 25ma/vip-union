...
interface QueryApplySellingServiceIf{
	...
	public function batchQueryPurchaseList(\com\vip\vis\purchase\schedules\service\query\BatchQueryPurchaseParam $param);
...
class _QueryApplySellingServiceClient extends \Osp\Base\OspStub implements \com\vip\vis\purchase\schedules\service\query\QueryApplySellingServiceIf{
	...
	public function batchQueryPurchaseList(\com\vip\vis\purchase\schedules\service\query\BatchQueryPurchaseParam $param){
		...
		$this->send_batchQueryPurchaseList( $param);
		return $this->recv_batchQueryPurchaseList();
	}
	
	public function send_batchQueryPurchaseList(\com\vip\vis\purchase\schedules\service\query\BatchQueryPurchaseParam $param){
		
		$this->initInvocation("batchQueryPurchaseList");
		$args = new \com\vip\vis\purchase\schedules\service\query\QueryApplySellingService_batchQueryPurchaseList_args();
	...
	public function recv_batchQueryPurchaseList(){
		
		$result = new \com\vip\vis\purchase\schedules\service\query\QueryApplySellingService_batchQueryPurchaseList_result();
...
class QueryApplySellingService_batchQueryPurchaseList_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->param = new \com\vip\vis\purchase\schedules\service\query\BatchQueryPurchaseParam();
...
class QueryApplySellingService_batchQueryPurchaseList_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem0 = new \com\vip\vis\purchase\schedules\service\query\PurchaseRespData();
					$elem0->read($input);
