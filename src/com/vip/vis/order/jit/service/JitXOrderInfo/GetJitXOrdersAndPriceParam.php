...
class GetJitXOrdersAndPriceParam {
	...
	public function getName(){
		...
		return 'GetJitXOrdersAndPriceParam';
	}
			...
			if ("order_status" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->order_status[$_size0++] = $elem0;
					}
					catch(\Exception $e){
			...
			if ("cooperation_nos" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->cooperation_nos[$_size1++] = $elem1;
					}
					catch(\Exception $e){
			...
			if ("delivery_warehouse_codes" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$this->delivery_warehouse_codes[$_size2++] = $elem2;
					}
					catch(\Exception $e){
