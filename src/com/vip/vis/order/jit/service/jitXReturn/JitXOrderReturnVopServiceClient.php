...
class JitXOrderReturnVopServiceClient{
	...
	public static function getService(){
		...
		if (! JitXOrderReturnVopServiceClient::$isRegis){
			
			JitXOrderReturnVopServiceClient::regis ();
			JitXOrderReturnVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = JitXOrderReturnVopServiceClient::$DEFAULT_PROXY_IP;
		$port = JitXOrderReturnVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\order\jit\service\jitXReturn\JitXOrderReturnVopServiceHelper();
	}
