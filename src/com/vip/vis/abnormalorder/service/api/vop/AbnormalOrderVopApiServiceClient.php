...
class AbnormalOrderVopApiServiceClient{
	...
	public static function getService(){
		...
		if (! AbnormalOrderVopApiServiceClient::$isRegis){
			
			AbnormalOrderVopApiServiceClient::regis ();
			AbnormalOrderVopApiServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AbnormalOrderVopApiServiceClient::$DEFAULT_PROXY_IP;
		$port = AbnormalOrderVopApiServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\abnormalorder\service\api\vop\AbnormalOrderVopApiServiceHelper();
	}
