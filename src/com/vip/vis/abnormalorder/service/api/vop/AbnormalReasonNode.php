...
class AbnormalReasonNode {
			...
			if ("children" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\vis\abnormalorder\service\api\vop\AbnormalReasonNode();
						$elem0->read($input);
	...
	public function write($output){
		...
		if($this->valid !== null) {
			...
			$xfer += $output->writeFieldBegin('valid');
