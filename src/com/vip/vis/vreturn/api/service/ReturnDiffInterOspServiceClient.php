...
class ReturnDiffInterOspServiceClient{
	...
	public static function getService(){
		...
		if (! ReturnDiffInterOspServiceClient::$isRegis){
			
			ReturnDiffInterOspServiceClient::regis ();
			ReturnDiffInterOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReturnDiffInterOspServiceClient::$DEFAULT_PROXY_IP;
		$port = ReturnDiffInterOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\vreturn\api\service\ReturnDiffInterOspServiceHelper();
	}
