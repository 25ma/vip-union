...
class ReturnDiffOperateOspServiceClient{
	...
	public static function getService(){
		...
		if (! ReturnDiffOperateOspServiceClient::$isRegis){
			
			ReturnDiffOperateOspServiceClient::regis ();
			ReturnDiffOperateOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReturnDiffOperateOspServiceClient::$DEFAULT_PROXY_IP;
		$port = ReturnDiffOperateOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\vreturn\api\service\ReturnDiffOperateOspServiceHelper();
	}
