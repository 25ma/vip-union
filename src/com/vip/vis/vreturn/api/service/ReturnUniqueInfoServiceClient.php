...
class ReturnUniqueInfoServiceClient{
	...
	public static function getService(){
		...
		if (! ReturnUniqueInfoServiceClient::$isRegis){
			
			ReturnUniqueInfoServiceClient::regis ();
			ReturnUniqueInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReturnUniqueInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = ReturnUniqueInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\vreturn\api\service\ReturnUniqueInfoServiceHelper();
	}
