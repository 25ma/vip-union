...
class VendorReturnConfirmOspServiceClient{
	...
	public static function getService(){
		...
		if (! VendorReturnConfirmOspServiceClient::$isRegis){
			
			VendorReturnConfirmOspServiceClient::regis ();
			VendorReturnConfirmOspServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VendorReturnConfirmOspServiceClient::$DEFAULT_PROXY_IP;
		$port = VendorReturnConfirmOspServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\vreturn\api\service\VendorReturnConfirmOspServiceHelper();
	}
