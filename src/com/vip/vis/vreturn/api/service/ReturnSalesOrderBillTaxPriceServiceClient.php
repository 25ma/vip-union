...
class ReturnSalesOrderBillTaxPriceServiceClient{
	...
	public static function getService(){
		...
		if (! ReturnSalesOrderBillTaxPriceServiceClient::$isRegis){
			
			ReturnSalesOrderBillTaxPriceServiceClient::regis ();
			ReturnSalesOrderBillTaxPriceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ReturnSalesOrderBillTaxPriceServiceClient::$DEFAULT_PROXY_IP;
		$port = ReturnSalesOrderBillTaxPriceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\vreturn\api\service\ReturnSalesOrderBillTaxPriceServiceHelper();
	}
