...
class VopSiInvInfoServiceClient{
	...
	public static function getService(){
		...
		if (! VopSiInvInfoServiceClient::$isRegis){
			
			VopSiInvInfoServiceClient::regis ();
			VopSiInvInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VopSiInvInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = VopSiInvInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\vis\analysis\api\service\VopSiInvInfoServiceHelper();
	}
