...
class ModifyDeductionOrderBizServiceClient{
	...
	public static function getService(){
		...
		if (! ModifyDeductionOrderBizServiceClient::$isRegis){
			
			ModifyDeductionOrderBizServiceClient::regis ();
			ModifyDeductionOrderBizServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ModifyDeductionOrderBizServiceClient::$DEFAULT_PROXY_IP;
		$port = ModifyDeductionOrderBizServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\ofc\tp\biz\service\deductionorder\ModifyDeductionOrderBizServiceHelper();
	}
