...
class BrandUserUpdateServiceClient{
	...
	public static function getService(){
		...
		if (! BrandUserUpdateServiceClient::$isRegis){
			
			BrandUserUpdateServiceClient::regis ();
			BrandUserUpdateServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = BrandUserUpdateServiceClient::$DEFAULT_PROXY_IP;
		$port = BrandUserUpdateServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\branduser\facade\member\BrandUserUpdateServiceHelper();
	}
