...
class BrandOrderServiceClient{
	...
	public static function getService(){
		...
		if (! BrandOrderServiceClient::$isRegis){
			
			BrandOrderServiceClient::regis ();
			BrandOrderServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = BrandOrderServiceClient::$DEFAULT_PROXY_IP;
		$port = BrandOrderServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\branduser\facade\order\BrandOrderServiceHelper();
	}
