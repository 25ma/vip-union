...
class MailServiceClient{
	...
	public static function getService(){
		...
		if (! MailServiceClient::$isRegis){
			
			MailServiceClient::regis ();
			MailServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = MailServiceClient::$DEFAULT_PROXY_IP;
		$port = MailServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\purchase\service\MailServiceHelper();
	}
