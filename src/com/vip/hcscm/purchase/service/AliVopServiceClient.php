...
class AliVopServiceClient{
	...
	public static function getService(){
		...
		if (! AliVopServiceClient::$isRegis){
			
			AliVopServiceClient::regis ();
			AliVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = AliVopServiceClient::$DEFAULT_PROXY_IP;
		$port = AliVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\purchase\service\AliVopServiceHelper();
	}
