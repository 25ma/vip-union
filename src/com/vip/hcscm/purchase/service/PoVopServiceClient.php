...
class PoVopServiceClient{
	...
	public static function getService(){
		...
		if (! PoVopServiceClient::$isRegis){
			
			PoVopServiceClient::regis ();
			PoVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = PoVopServiceClient::$DEFAULT_PROXY_IP;
		$port = PoVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\purchase\service\PoVopServiceHelper();
	}
