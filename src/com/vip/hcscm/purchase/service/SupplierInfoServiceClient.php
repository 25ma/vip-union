...
class SupplierInfoServiceClient{
	...
	public static function getService(){
		...
		if (! SupplierInfoServiceClient::$isRegis){
			
			SupplierInfoServiceClient::regis ();
			SupplierInfoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SupplierInfoServiceClient::$DEFAULT_PROXY_IP;
		$port = SupplierInfoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\purchase\service\SupplierInfoServiceHelper();
	}
