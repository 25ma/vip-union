...
class SoOperationServiceClient{
	...
	public static function getService(){
		...
		if (! SoOperationServiceClient::$isRegis){
			
			SoOperationServiceClient::regis ();
			SoOperationServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SoOperationServiceClient::$DEFAULT_PROXY_IP;
		$port = SoOperationServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\cis\service\SoOperationServiceHelper();
	}
