...
class SoServiceClient{
	...
	public static function getService(){
		...
		if (! SoServiceClient::$isRegis){
			
			SoServiceClient::regis ();
			SoServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SoServiceClient::$DEFAULT_PROXY_IP;
		$port = SoServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\cis\service\SoServiceHelper();
	}
