...
class WarehouseServiceClient{
	...
	public static function getService(){
		...
		if (! WarehouseServiceClient::$isRegis){
			
			WarehouseServiceClient::regis ();
			WarehouseServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WarehouseServiceClient::$DEFAULT_PROXY_IP;
		$port = WarehouseServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\cis\service\WarehouseServiceHelper();
	}
