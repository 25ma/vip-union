...
class WmsServiceClient{
	...
	public static function getService(){
		...
		if (! WmsServiceClient::$isRegis){
			
			WmsServiceClient::regis ();
			WmsServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = WmsServiceClient::$DEFAULT_PROXY_IP;
		$port = WmsServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\cis\service\WmsServiceHelper();
	}
