...
class GoodsInventoryServiceClient{
	...
	public static function getService(){
		...
		if (! GoodsInventoryServiceClient::$isRegis){
			
			GoodsInventoryServiceClient::regis ();
			GoodsInventoryServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = GoodsInventoryServiceClient::$DEFAULT_PROXY_IP;
		$port = GoodsInventoryServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\hcscm\cis\service\GoodsInventoryServiceHelper();
	}
