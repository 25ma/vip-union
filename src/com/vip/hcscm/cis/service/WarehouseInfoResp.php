			...
			if ("storeList" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\hcscm\cis\service\StoreInfo();
						$elem1->read($input);
						
						$this->storeList[$_size1++] = $elem1;
					}
					catch(\Exception $e){
			...
			if ("warehouseAddressRspInfos" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem2 = new \com\vip\hcscm\cis\service\WarehouseAddressRspInfo();
						$elem2->read($input);
						
						$this->warehouseAddressRspInfos[$_size2++] = $elem2;
					}
					catch(\Exception $e){
