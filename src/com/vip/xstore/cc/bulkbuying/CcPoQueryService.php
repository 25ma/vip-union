...
interface CcPoQueryServiceIf{
	...
	public function queryCcPurchaseOrderItems(\com\vip\xstore\cc\bulkbuying\QueryCcPoItemReq $req);
	
	public function queryPoBasicInfo(\com\vip\xstore\cc\bulkbuying\QueryPoBasicInfoReq $req);
	
	public function queryPoListByBizBatchNo(\com\vip\xstore\cc\bulkbuying\QueryPoListByBizBatchNoReq $req);
	
	public function queryPurchaseItemInfo(\com\vip\xstore\cc\bulkbuying\PurchaseOrderItemReq $req);
	
	public function queryPurchaseItemInfos(\com\vip\xstore\cc\bulkbuying\PurchaseOrderItemInfosReq $req);
	
	public function queryPurchaseNoByBarcode(\com\vip\xstore\cc\bulkbuying\QueryPurchaseNoByBarcodeReq $req);
	
	public function querySsPos(\com\vip\xstore\cc\bulkbuying\PurchaseOrderSsReq $req);
...
class _CcPoQueryServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\cc\bulkbuying\CcPoQueryServiceIf{
	...
	public function queryCcPurchaseOrderItems(\com\vip\xstore\cc\bulkbuying\QueryCcPoItemReq $req){
		...
		$this->send_queryCcPurchaseOrderItems( $req);
		return $this->recv_queryCcPurchaseOrderItems();
	}
	
	public function send_queryCcPurchaseOrderItems(\com\vip\xstore\cc\bulkbuying\QueryCcPoItemReq $req){
		
		$this->initInvocation("queryCcPurchaseOrderItems");
		$args = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryCcPurchaseOrderItems_args();
	...
	public function recv_queryCcPurchaseOrderItems(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryCcPurchaseOrderItems_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryPoBasicInfo(\com\vip\xstore\cc\bulkbuying\QueryPoBasicInfoReq $req){
		...
		$this->send_queryPoBasicInfo( $req);
		return $this->recv_queryPoBasicInfo();
	}
	
	public function send_queryPoBasicInfo(\com\vip\xstore\cc\bulkbuying\QueryPoBasicInfoReq $req){
		
		$this->initInvocation("queryPoBasicInfo");
		$args = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryPoBasicInfo_args();
	...
	public function recv_queryPoBasicInfo(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryPoBasicInfo_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryPurchaseItemInfo(\com\vip\xstore\cc\bulkbuying\PurchaseOrderItemReq $req){
		...
		$this->send_queryPurchaseItemInfo( $req);
		return $this->recv_queryPurchaseItemInfo();
	}
	
	public function send_queryPurchaseItemInfo(\com\vip\xstore\cc\bulkbuying\PurchaseOrderItemReq $req){
		
		$this->initInvocation("queryPurchaseItemInfo");
		$args = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryPurchaseItemInfo_args();
	...
	public function recv_queryPurchaseItemInfo(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryPurchaseItemInfo_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryPurchaseItemInfos(\com\vip\xstore\cc\bulkbuying\PurchaseOrderItemInfosReq $req){
		...
		$this->send_queryPurchaseItemInfos( $req);
		return $this->recv_queryPurchaseItemInfos();
	}
	
	public function send_queryPurchaseItemInfos(\com\vip\xstore\cc\bulkbuying\PurchaseOrderItemInfosReq $req){
		
		$this->initInvocation("queryPurchaseItemInfos");
		$args = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryPurchaseItemInfos_args();
	...
	public function recv_queryPurchaseItemInfos(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_queryPurchaseItemInfos_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function querySsPos(\com\vip\xstore\cc\bulkbuying\PurchaseOrderSsReq $req){
		...
		$this->send_querySsPos( $req);
		return $this->recv_querySsPos();
	}
	
	public function send_querySsPos(\com\vip\xstore\cc\bulkbuying\PurchaseOrderSsReq $req){
		
		$this->initInvocation("querySsPos");
		$args = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_querySsPos_args();
	...
	public function recv_querySsPos(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\CcPoQueryService_querySsPos_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class CcPoQueryService_queryCcPurchaseOrderItems_args {
...
class CcPoQueryService_queryPoBasicInfo_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\cc\bulkbuying\QueryPoBasicInfoReq();
			$this->req->read($input);
...
class CcPoQueryService_queryPurchaseItemInfo_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\cc\bulkbuying\PurchaseOrderItemReq();
			$this->req->read($input);
...
class CcPoQueryService_queryPurchaseItemInfos_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\cc\bulkbuying\PurchaseOrderItemInfosReq();
			$this->req->read($input);
...
class CcPoQueryService_querySsPos_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\cc\bulkbuying\PurchaseOrderSsReq();
			$this->req->read($input);
...
class CcPoQueryService_queryCcPurchaseOrderItems_result {
...
class CcPoQueryService_queryPoBasicInfo_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem0 = new \com\vip\xstore\cc\bulkbuying\CcPoBasic();
					$elem0->read($input);
...
class CcPoQueryService_queryPurchaseItemInfo_result {
...
class CcPoQueryService_queryPurchaseItemInfos_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\xstore\cc\bulkbuying\PurchaseOrderItemInfosResp();
			$this->success->read($input);
...
class CcPoQueryService_querySsPos_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem2 = new \com\vip\xstore\cc\bulkbuying\PurchaseOrderSsInfo();
					$elem2->read($input);
