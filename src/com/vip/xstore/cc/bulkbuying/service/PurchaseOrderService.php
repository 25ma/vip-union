...
interface PurchaseOrderServiceIf{
	...
	public function getPurchaseStopOrderList(\com\vip\xstore\cc\bulkbuying\service\PurchaseStopOrderReq $request);
	
	public function getSupplementPos( $keywordPo);
	
	public function healthCheck();
	
	public function importReceiveItem(\com\vip\xstore\cc\bulkbuying\service\ImportReceiveItemReq $request);
	
	public function processExcel(\com\vip\xstore\cc\bulkbuying\service\ProcessExcelReq $req);
...
class _PurchaseOrderServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderServiceIf{
	...
	public function getPurchaseStopOrderList(\com\vip\xstore\cc\bulkbuying\service\PurchaseStopOrderReq $request){
		...
		$this->send_getPurchaseStopOrderList( $request);
		return $this->recv_getPurchaseStopOrderList();
	}
	
	public function send_getPurchaseStopOrderList(\com\vip\xstore\cc\bulkbuying\service\PurchaseStopOrderReq $request){
		
		$this->initInvocation("getPurchaseStopOrderList");
		$args = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_getPurchaseStopOrderList_args();
	...
	public function recv_getPurchaseStopOrderList(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_getPurchaseStopOrderList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getSupplementPos( $keywordPo){
		...
		$this->send_getSupplementPos( $keywordPo);
		return $this->recv_getSupplementPos();
	}
	
	public function send_getSupplementPos( $keywordPo){
		
		$this->initInvocation("getSupplementPos");
		$args = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_getSupplementPos_args();
		
		$args->keywordPo = $keywordPo;
		
		$this->send_base($args);
	}
	
	public function recv_getSupplementPos(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_getSupplementPos_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function importReceiveItem(\com\vip\xstore\cc\bulkbuying\service\ImportReceiveItemReq $request){
		...
		$this->send_importReceiveItem( $request);
		return $this->recv_importReceiveItem();
	}
	
	public function send_importReceiveItem(\com\vip\xstore\cc\bulkbuying\service\ImportReceiveItemReq $request){
		
		$this->initInvocation("importReceiveItem");
		$args = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_importReceiveItem_args();
	...
	public function recv_importReceiveItem(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_importReceiveItem_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function processExcel(\com\vip\xstore\cc\bulkbuying\service\ProcessExcelReq $req){
		...
		$this->send_processExcel( $req);
		return $this->recv_processExcel();
	}
	
	public function send_processExcel(\com\vip\xstore\cc\bulkbuying\service\ProcessExcelReq $req){
		
		$this->initInvocation("processExcel");
		$args = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_processExcel_args();
	...
	public function recv_processExcel(){
		
		$result = new \com\vip\xstore\cc\bulkbuying\service\PurchaseOrderService_processExcel_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class PurchaseOrderService_getPurchaseStopOrderList_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\xstore\cc\bulkbuying\service\PurchaseStopOrderReq();
			$this->request->read($input);
...
class PurchaseOrderService_getSupplementPos_args {
	
	static $_TSPEC;
	public $keywordPo = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['keywordPo'])){
				
				$this->keywordPo = $vals['keywordPo'];
			}
	...
	public function read($input){
		...
		if(true) {
			...
			$input->readString($this->keywordPo);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('keywordPo');
		$xfer += $output->writeString($this->keywordPo);
...
class PurchaseOrderService_importReceiveItem_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\xstore\cc\bulkbuying\service\ImportReceiveItemReq();
			$this->request->read($input);
...
class PurchaseOrderService_processExcel_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\cc\bulkbuying\service\ProcessExcelReq();
			$this->req->read($input);
...
class PurchaseOrderService_getPurchaseStopOrderList_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\xstore\cc\bulkbuying\service\PurchaseStopOrderResp();
			$this->success->read($input);
...
class PurchaseOrderService_getSupplementPos_result {
...
class PurchaseOrderService_importReceiveItem_result {
...
class PurchaseOrderService_processExcel_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\xstore\cc\bulkbuying\service\ProcessExcelResp();
			$this->success->read($input);
