...
class CcPoItem {
	...
	public $parentBarcode = null;
	public $flawLevel = null;
	public $qualityPeriodStr = null;
	public $costPricePlus = null;
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['parentBarcode'])){
				
				$this->parentBarcode = $vals['parentBarcode'];
			}
			
			
			if (isset($vals['flawLevel'])){
				
				$this->flawLevel = $vals['flawLevel'];
			}
			
			
			if (isset($vals['qualityPeriodStr'])){
				
				$this->qualityPeriodStr = $vals['qualityPeriodStr'];
			}
			
			
			if (isset($vals['costPricePlus'])){
				
				$this->costPricePlus = $vals['costPricePlus'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("parentBarcode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->parentBarcode);
			...
			if ("flawLevel" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->flawLevel);
			...
			if ("qualityPeriodStr" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->qualityPeriodStr);
			...
			if ("costPricePlus" == $schemeField){
				
				$needSkip = false;
				$input->readDouble($this->costPricePlus);
	...
	public function write($output){
		...
		if($this->parentBarcode !== null) {
			...
			$xfer += $output->writeFieldBegin('parentBarcode');
			$xfer += $output->writeString($this->parentBarcode);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->flawLevel !== null) {
			
			$xfer += $output->writeFieldBegin('flawLevel');
			$xfer += $output->writeString($this->flawLevel);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->qualityPeriodStr !== null) {
			
			$xfer += $output->writeFieldBegin('qualityPeriodStr');
			$xfer += $output->writeString($this->qualityPeriodStr);
			
			$xfer += $output->writeFieldEnd();
		}
		
		
		if($this->costPricePlus !== null) {
			
			$xfer += $output->writeFieldBegin('costPricePlus');
			$xfer += $output->writeDouble($this->costPricePlus);
