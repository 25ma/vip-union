...
interface OfcServiceIf{
	...
	public function batchUpdateOrderStatus(\com\vip\xstore\order\common\pojo\vo\RequestHeader $header,\com\vip\xstore\order\ofc\api\request\BatchUpdateOrderStatusReq $req);
	...
	public function updateOrderStatus(\com\vip\xstore\order\common\pojo\vo\RequestHeader $header,\com\vip\xstore\order\ofc\api\request\UpdateOrderStatusReq $req);
...
class _OfcServiceClient extends \Osp\Base\OspStub implements \com\vip\xstore\order\ofc\api\service\OfcServiceIf{
	...
	public function batchUpdateOrderStatus(\com\vip\xstore\order\common\pojo\vo\RequestHeader $header,\com\vip\xstore\order\ofc\api\request\BatchUpdateOrderStatusReq $req){
		...
		$this->send_batchUpdateOrderStatus( $header, $req);
		return $this->recv_batchUpdateOrderStatus();
	}
	
	public function send_batchUpdateOrderStatus(\com\vip\xstore\order\common\pojo\vo\RequestHeader $header,\com\vip\xstore\order\ofc\api\request\BatchUpdateOrderStatusReq $req){
		
		$this->initInvocation("batchUpdateOrderStatus");
		$args = new \com\vip\xstore\order\ofc\api\service\OfcService_batchUpdateOrderStatus_args();
	...
	public function recv_batchUpdateOrderStatus(){
		
		$result = new \com\vip\xstore\order\ofc\api\service\OfcService_batchUpdateOrderStatus_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function updateOrderStatus(\com\vip\xstore\order\common\pojo\vo\RequestHeader $header,\com\vip\xstore\order\ofc\api\request\UpdateOrderStatusReq $req){
		...
		$this->send_updateOrderStatus( $header, $req);
		return $this->recv_updateOrderStatus();
	}
	
	public function send_updateOrderStatus(\com\vip\xstore\order\common\pojo\vo\RequestHeader $header,\com\vip\xstore\order\ofc\api\request\UpdateOrderStatusReq $req){
		
		$this->initInvocation("updateOrderStatus");
		$args = new \com\vip\xstore\order\ofc\api\service\OfcService_updateOrderStatus_args();
	...
	public function recv_updateOrderStatus(){
		...
		$result = new \com\vip\xstore\order\ofc\api\service\OfcService_updateOrderStatus_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class OfcService_batchUpdateOrderStatus_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\order\ofc\api\request\BatchUpdateOrderStatusReq();
			$this->req->read($input);
...
class OfcService_updateOrderStatus_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->req = new \com\vip\xstore\order\ofc\api\request\UpdateOrderStatusReq();
			$this->req->read($input);
...
class OfcService_batchUpdateOrderStatus_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\xstore\order\ofc\api\response\BatchUpdateOrderStatusResp();
			$this->success->read($input);
...
class OfcService_updateOrderStatus_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\xstore\order\ofc\api\response\UpdateOrderStatusResp();
			$this->success->read($input);
