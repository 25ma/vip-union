...
class DeliverOrderReq {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['deliveryMan'])){
				
				$this->deliveryMan = $vals['deliveryMan'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("deliveryMan" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->deliveryMan);
	...
	public function write($output){
		...
		if($this->deliveryMan !== null) {
			...
			$xfer += $output->writeFieldBegin('deliveryMan');
			$xfer += $output->writeString($this->deliveryMan);
