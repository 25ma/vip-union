...
class InfOutletsOrdersVO {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['presellRefundType'])){
				
				$this->presellRefundType = $vals['presellRefundType'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("presellRefundType" == $schemeField){
				
				$needSkip = false;
				$input->readI32($this->presellRefundType); 
	...
	public function write($output){
		...
		if($this->presellRefundType !== null) {
			
			$xfer += $output->writeFieldBegin('presellRefundType');
			$xfer += $output->writeI32($this->presellRefundType);
