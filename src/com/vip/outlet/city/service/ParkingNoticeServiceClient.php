...
class ParkingNoticeServiceClient{
	...
	public static function getService(){
		...
		if (! ParkingNoticeServiceClient::$isRegis){
			
			ParkingNoticeServiceClient::regis ();
			ParkingNoticeServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = ParkingNoticeServiceClient::$DEFAULT_PROXY_IP;
		$port = ParkingNoticeServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\outlet\city\service\ParkingNoticeServiceHelper();
	}
