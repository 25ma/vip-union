...
class AnormalRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['reportOrgCode'])){
				
				$this->reportOrgCode = $vals['reportOrgCode'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("reportOrgCode" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->reportOrgCode);
	...
	public function write($output){
		...
		if($this->reportOrgCode !== null) {
			
			$xfer += $output->writeFieldBegin('reportOrgCode');
			$xfer += $output->writeString($this->reportOrgCode);
