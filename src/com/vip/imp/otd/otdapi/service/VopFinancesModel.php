	...
	public function read($input){
		...
		while(true){
			...
			if ("data" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\imp\otd\otdapi\service\VopFinanceModel();
						$elem0->read($input);
			...
			if ("page" == $schemeField){
				...
				$this->page = new \com\vip\imp\otd\otdapi\service\VopFinancePageModel();
