...
class VopFinanceServiceClient{
	...
	public static function getService(){
		...
		if (! VopFinanceServiceClient::$isRegis){
			
			VopFinanceServiceClient::regis ();
			VopFinanceServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = VopFinanceServiceClient::$DEFAULT_PROXY_IP;
		$port = VopFinanceServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\imp\otd\otdapi\service\VopFinanceServiceHelper();
	}
