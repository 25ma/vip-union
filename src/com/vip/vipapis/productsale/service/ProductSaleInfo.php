...
class ProductSaleInfo {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['childOrderSn'])){
				
				$this->childOrderSn = $vals['childOrderSn'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("childOrderSn" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->childOrderSn);
	...
	public function write($output){
		...
		if($this->childOrderSn !== null) {
			
			$xfer += $output->writeFieldBegin('childOrderSn');
			$xfer += $output->writeString($this->childOrderSn);
