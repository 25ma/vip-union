...
interface HtOrderStatusCancelServiceIf{
	...
	public function getOrderList( $warehouse, $takeStatus, $num);
	...
	public function updateByOrderSnList( $orderSnList, $takeStatus, $updateUser);
...
class _HtOrderStatusCancelServiceClient extends \Osp\Base\OspStub implements \com\vip\haitao\order\osp\service\HtOrderStatusCancelServiceIf{
	...
	public function getOrderList( $warehouse, $takeStatus, $num){
		...
		$this->send_getOrderList( $warehouse, $takeStatus, $num);
		return $this->recv_getOrderList();
	}
	
	public function send_getOrderList( $warehouse, $takeStatus, $num){
		
		$this->initInvocation("getOrderList");
		$args = new \com\vip\haitao\order\osp\service\HtOrderStatusCancelService_getOrderList_args();
	...
	public function recv_getOrderList(){
		...
		$result = new \com\vip\haitao\order\osp\service\HtOrderStatusCancelService_getOrderList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function updateByOrderSnList( $orderSnList, $takeStatus, $updateUser){
		...
		$this->send_updateByOrderSnList( $orderSnList, $takeStatus, $updateUser);
		return $this->recv_updateByOrderSnList();
	}
	
	public function send_updateByOrderSnList( $orderSnList, $takeStatus, $updateUser){
		
		$this->initInvocation("updateByOrderSnList");
		$args = new \com\vip\haitao\order\osp\service\HtOrderStatusCancelService_updateByOrderSnList_args();
		
		$args->orderSnList = $orderSnList;
		
		$args->takeStatus = $takeStatus;
		
		$args->updateUser = $updateUser;
		
		$this->send_base($args);
	}
	
	public function recv_updateByOrderSnList(){
		
		$result = new \com\vip\haitao\order\osp\service\HtOrderStatusCancelService_updateByOrderSnList_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class HtOrderStatusCancelService_getOrderList_args {
...
class HtOrderStatusCancelService_updateByOrderSnList_args {
...
class HtOrderStatusCancelService_getOrderList_result {
		...
		if(true) {
			...
			while(true){
				...
				try{
					...
					$elem1 = new \com\vip\haitao\order\osp\service\HtOrderStatusCancelModel();
					$elem1->read($input);
...
class HtOrderStatusCancelService_updateByOrderSnList_result {
