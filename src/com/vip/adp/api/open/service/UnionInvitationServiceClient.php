...
class UnionInvitationServiceClient{
	...
	public static function getService(){
		...
		if (! UnionInvitationServiceClient::$isRegis){
			
			UnionInvitationServiceClient::regis ();
			UnionInvitationServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = UnionInvitationServiceClient::$DEFAULT_PROXY_IP;
		$port = UnionInvitationServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\adp\api\open\service\UnionInvitationServiceHelper();
	}
