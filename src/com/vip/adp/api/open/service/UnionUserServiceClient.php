...
class UnionUserServiceClient{
	...
	public static function getService(){
		...
		if (! UnionUserServiceClient::$isRegis){
			
			UnionUserServiceClient::regis ();
			UnionUserServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = UnionUserServiceClient::$DEFAULT_PROXY_IP;
		$port = UnionUserServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\adp\api\open\service\UnionUserServiceHelper();
	}
