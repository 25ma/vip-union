...
interface UnionGoodsServiceIf{
	...
	public function getBrandDetail(\com\vip\adp\api\open\service\BrandDetailRequest $request);
	
	public function getBrandDetailWithOauth(\com\vip\adp\api\open\service\BrandDetailRequest $request);
	
	public function getBrandSnList(\com\vip\adp\api\open\service\BrandSnListRequest $request);
	
	public function getBrandSnListWithOauth(\com\vip\adp\api\open\service\BrandSnListRequest $request);
	
	public function getByGoodsIds( $goodsIdList, $requestId, $chanTag,\com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest $request);
	...
	public function getByGoodsIdsWithOauth( $goodsIdList, $requestId, $chanTag,\com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest $request);
	...
	public function goodsListV2(\com\vip\adp\api\open\service\GoodsInfoRequestV2 $request);
	
	public function goodsListV2WithOauth(\com\vip\adp\api\open\service\GoodsInfoRequestV2 $request);
	...
	public function queryByBrandSn(\com\vip\adp\api\open\service\BrandSnQueryGoodsRequest $request);
	
	public function queryByBrandSnWithOauth(\com\vip\adp\api\open\service\BrandSnQueryGoodsRequest $request);
	
	public function queryCompetitorMatchingProduct(\com\vip\adp\api\open\service\CompetitorMatchingProductRequest $request);
	
	public function queryCompetitorMatchingProductWithOauth(\com\vip\adp\api\open\service\CompetitorMatchingProductRequest $request);
...
class _UnionGoodsServiceClient extends \Osp\Base\OspStub implements \com\vip\adp\api\open\service\UnionGoodsServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("com.vip.adp.api.open.service.UnionGoodsService", "1.3.0");
	}
	
	
	public function getBrandDetail(\com\vip\adp\api\open\service\BrandDetailRequest $request){
		
		$this->send_getBrandDetail( $request);
		return $this->recv_getBrandDetail();
	}
	
	public function send_getBrandDetail(\com\vip\adp\api\open\service\BrandDetailRequest $request){
		
		$this->initInvocation("getBrandDetail");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandDetail_args();
	...
	public function recv_getBrandDetail(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandDetail_result();
	...
	public function getBrandDetailWithOauth(\com\vip\adp\api\open\service\BrandDetailRequest $request){
		...
		$this->send_getBrandDetailWithOauth( $request);
		return $this->recv_getBrandDetailWithOauth();
	}
	
	public function send_getBrandDetailWithOauth(\com\vip\adp\api\open\service\BrandDetailRequest $request){
		
		$this->initInvocation("getBrandDetailWithOauth");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandDetailWithOauth_args();
	...
	public function recv_getBrandDetailWithOauth(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandDetailWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getBrandSnList(\com\vip\adp\api\open\service\BrandSnListRequest $request){
		...
		$this->send_getBrandSnList( $request);
		return $this->recv_getBrandSnList();
	}
	
	public function send_getBrandSnList(\com\vip\adp\api\open\service\BrandSnListRequest $request){
		
		$this->initInvocation("getBrandSnList");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandSnList_args();
	...
	public function recv_getBrandSnList(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandSnList_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getBrandSnListWithOauth(\com\vip\adp\api\open\service\BrandSnListRequest $request){
		...
		$this->send_getBrandSnListWithOauth( $request);
		return $this->recv_getBrandSnListWithOauth();
	}
	
	public function send_getBrandSnListWithOauth(\com\vip\adp\api\open\service\BrandSnListRequest $request){
		
		$this->initInvocation("getBrandSnListWithOauth");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandSnListWithOauth_args();
	...
	public function recv_getBrandSnListWithOauth(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_getBrandSnListWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function getByGoodsIds( $goodsIdList, $requestId, $chanTag,\com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest $request){
		...
		$this->send_getByGoodsIds( $goodsIdList, $requestId, $chanTag, $request);
		return $this->recv_getByGoodsIds();
	}
	
	public function send_getByGoodsIds( $goodsIdList, $requestId, $chanTag,\com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest $request){
	...
	public function getByGoodsIdsWithOauth( $goodsIdList, $requestId, $chanTag,\com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest $request){
		...
		$this->send_getByGoodsIdsWithOauth( $goodsIdList, $requestId, $chanTag, $request);
		return $this->recv_getByGoodsIdsWithOauth();
	}
	
	public function send_getByGoodsIdsWithOauth( $goodsIdList, $requestId, $chanTag,\com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest $request){
	...
	public function goodsListV2(\com\vip\adp\api\open\service\GoodsInfoRequestV2 $request){
		...
		$this->send_goodsListV2( $request);
		return $this->recv_goodsListV2();
	}
	
	public function send_goodsListV2(\com\vip\adp\api\open\service\GoodsInfoRequestV2 $request){
		
		$this->initInvocation("goodsListV2");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_goodsListV2_args();
	...
	public function recv_goodsListV2(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_goodsListV2_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function goodsListV2WithOauth(\com\vip\adp\api\open\service\GoodsInfoRequestV2 $request){
		...
		$this->send_goodsListV2WithOauth( $request);
		return $this->recv_goodsListV2WithOauth();
	}
	
	public function send_goodsListV2WithOauth(\com\vip\adp\api\open\service\GoodsInfoRequestV2 $request){
		
		$this->initInvocation("goodsListV2WithOauth");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_goodsListV2WithOauth_args();
	...
	public function recv_goodsListV2WithOauth(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_goodsListV2WithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryByBrandSn(\com\vip\adp\api\open\service\BrandSnQueryGoodsRequest $request){
		...
		$this->send_queryByBrandSn( $request);
		return $this->recv_queryByBrandSn();
	}
	
	public function send_queryByBrandSn(\com\vip\adp\api\open\service\BrandSnQueryGoodsRequest $request){
		
		$this->initInvocation("queryByBrandSn");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_queryByBrandSn_args();
	...
	public function recv_queryByBrandSn(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_queryByBrandSn_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryByBrandSnWithOauth(\com\vip\adp\api\open\service\BrandSnQueryGoodsRequest $request){
		...
		$this->send_queryByBrandSnWithOauth( $request);
		return $this->recv_queryByBrandSnWithOauth();
	}
	
	public function send_queryByBrandSnWithOauth(\com\vip\adp\api\open\service\BrandSnQueryGoodsRequest $request){
		
		$this->initInvocation("queryByBrandSnWithOauth");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_queryByBrandSnWithOauth_args();
	...
	public function recv_queryByBrandSnWithOauth(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_queryByBrandSnWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryCompetitorMatchingProduct(\com\vip\adp\api\open\service\CompetitorMatchingProductRequest $request){
		...
		$this->send_queryCompetitorMatchingProduct( $request);
		return $this->recv_queryCompetitorMatchingProduct();
	}
	
	public function send_queryCompetitorMatchingProduct(\com\vip\adp\api\open\service\CompetitorMatchingProductRequest $request){
		
		$this->initInvocation("queryCompetitorMatchingProduct");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_queryCompetitorMatchingProduct_args();
	...
	public function recv_queryCompetitorMatchingProduct(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_queryCompetitorMatchingProduct_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function queryCompetitorMatchingProductWithOauth(\com\vip\adp\api\open\service\CompetitorMatchingProductRequest $request){
		...
		$this->send_queryCompetitorMatchingProductWithOauth( $request);
		return $this->recv_queryCompetitorMatchingProductWithOauth();
	}
	
	public function send_queryCompetitorMatchingProductWithOauth(\com\vip\adp\api\open\service\CompetitorMatchingProductRequest $request){
		
		$this->initInvocation("queryCompetitorMatchingProductWithOauth");
		$args = new \com\vip\adp\api\open\service\UnionGoodsService_queryCompetitorMatchingProductWithOauth_args();
	...
	public function recv_queryCompetitorMatchingProductWithOauth(){
		
		$result = new \com\vip\adp\api\open\service\UnionGoodsService_queryCompetitorMatchingProductWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class UnionGoodsService_getBrandDetail_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\adp\api\open\service\BrandDetailRequest();
...
class UnionGoodsService_getBrandDetailWithOauth_args {
...
class UnionGoodsService_getBrandSnList_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\adp\api\open\service\BrandSnListRequest();
			$this->request->read($input);
...
class UnionGoodsService_getBrandSnListWithOauth_args {
...
class UnionGoodsService_getByGoodsIds_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\adp\api\open\service\GoodsInfoByGoodsIdsRequest();
			$this->request->read($input);
...
class UnionGoodsService_goodsListV2_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\adp\api\open\service\GoodsInfoRequestV2();
			$this->request->read($input);
...
class UnionGoodsService_goodsListV2WithOauth_args {
...
class UnionGoodsService_queryByBrandSn_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\adp\api\open\service\BrandSnQueryGoodsRequest();
			$this->request->read($input);
...
class UnionGoodsService_queryByBrandSnWithOauth_args {
...
class UnionGoodsService_queryCompetitorMatchingProduct_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \com\vip\adp\api\open\service\CompetitorMatchingProductRequest();
			$this->request->read($input);
...
class UnionGoodsService_queryCompetitorMatchingProductWithOauth_args {
...
class UnionGoodsService_getBrandDetail_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\adp\api\open\service\BrandDetailResponse();
...
class UnionGoodsService_getBrandDetailWithOauth_result {
...
class UnionGoodsService_getBrandSnList_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\adp\api\open\service\BrandSnListResponse();
			$this->success->read($input);
...
class UnionGoodsService_getBrandSnListWithOauth_result {
...
class UnionGoodsService_goodsListV2_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\adp\api\open\service\GoodsInfoResponseV2();
			$this->success->read($input);
...
class UnionGoodsService_goodsListV2WithOauth_result {
...
class UnionGoodsService_queryByBrandSn_result {
...
class UnionGoodsService_queryByBrandSnWithOauth_result {
...
class UnionGoodsService_queryCompetitorMatchingProduct_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \com\vip\adp\api\open\service\CompetitorMatchingProductResponse();
			$this->success->read($input);
...
class UnionGoodsService_queryCompetitorMatchingProductWithOauth_result {
