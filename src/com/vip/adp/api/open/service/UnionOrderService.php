...
interface UnionOrderServiceIf{
	...
	public function getAdpOrderAdcode( $orderSn);
...
class _UnionOrderServiceClient extends \Osp\Base\OspStub implements \com\vip\adp\api\open\service\UnionOrderServiceIf{
	...
	public function __construct(){
		...
		parent::__construct("com.vip.adp.api.open.service.UnionOrderService", "1.3.0");
	}
	
	
	public function getAdpOrderAdcode( $orderSn){
		
		$this->send_getAdpOrderAdcode( $orderSn);
		return $this->recv_getAdpOrderAdcode();
	}
	
	public function send_getAdpOrderAdcode( $orderSn){
		
		$this->initInvocation("getAdpOrderAdcode");
		$args = new \com\vip\adp\api\open\service\UnionOrderService_getAdpOrderAdcode_args();
	...
	public function recv_getAdpOrderAdcode(){
		
		$result = new \com\vip\adp\api\open\service\UnionOrderService_getAdpOrderAdcode_result();
...
class UnionOrderService_getAdpOrderAdcode_args {
...
class UnionOrderService_getAdpOrderAdcode_result {
