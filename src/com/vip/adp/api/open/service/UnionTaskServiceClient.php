...
class UnionTaskServiceClient{
	...
	public static function getService(){
		...
		if (! UnionTaskServiceClient::$isRegis){
			
			UnionTaskServiceClient::regis ();
			UnionTaskServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = UnionTaskServiceClient::$DEFAULT_PROXY_IP;
		$port = UnionTaskServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\adp\api\open\service\UnionTaskServiceHelper();
	}
