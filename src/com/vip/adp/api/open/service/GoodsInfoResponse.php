...
class GoodsInfoResponse {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['recommendKeyword'])){
				
				$this->recommendKeyword = $vals['recommendKeyword'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("sortFields" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\adp\api\open\service\SortField();
						$elem1->read($input);
			...
			if ("recommendKeyword" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->recommendKeyword);
	...
	public function write($output){
		...
		if($this->recommendKeyword !== null) {
			...
			$xfer += $output->writeFieldBegin('recommendKeyword');
			$xfer += $output->writeString($this->recommendKeyword);
