...
class RefuseTransDetail {
			...
			if ("goodsDetail" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem0 = new \com\vip\sof\sof\service\RefuseGoodsDetail();
						$elem0->read($input);
						
						$this->goodsDetail[$_size0++] = $elem0;
					}
					catch(\Exception $e){
	...
	public function write($output){
		...
		if($this->goodsDetail !== null) {
			...
			if (!is_array($this->goodsDetail)){
				
				throw new \Osp\Exception\OspException('Bad type in structure.', \Osp\Exception\OspException::INVALID_DATA);
			}
			
			$output->writeListBegin();
			foreach ($this->goodsDetail as $iter0){
