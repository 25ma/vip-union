...
class TransportServiceClient{
	...
	public static function getService(){
		...
		if (! TransportServiceClient::$isRegis){
			
			TransportServiceClient::regis ();
			TransportServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TransportServiceClient::$DEFAULT_PROXY_IP;
		$port = TransportServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\sof\sof\service\TransportServiceHelper();
	}
