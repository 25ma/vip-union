...
class OrderDecryptResult {
	...
	public function read($input){
		...
		while(true){
			...
			if ("isAuthentication" == $schemeField){
				
				$needSkip = false;
				$input->readBool($this->isAuthentication);
	...
	public function write($output){
		...
		$xfer += $output->writeFieldBegin('isAuthentication');
		$xfer += $output->writeBool($this->isAuthentication);
