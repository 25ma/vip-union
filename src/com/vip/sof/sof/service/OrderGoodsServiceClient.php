...
class OrderGoodsServiceClient{
	...
	public static function getService(){
		...
		if (! OrderGoodsServiceClient::$isRegis){
			
			OrderGoodsServiceClient::regis ();
			OrderGoodsServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = OrderGoodsServiceClient::$DEFAULT_PROXY_IP;
		$port = OrderGoodsServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\sof\sof\service\OrderGoodsServiceHelper();
	}
