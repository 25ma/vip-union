...
class SofServiceClient{
	...
	public static function getService(){
		...
		if (! SofServiceClient::$isRegis){
			
			SofServiceClient::regis ();
			SofServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = SofServiceClient::$DEFAULT_PROXY_IP;
		$port = SofServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\sof\sof\service\SofServiceHelper();
	}
