...
class TmsVendorRelativeVopServiceClient{
	...
	public static function getService(){
		...
		if (! TmsVendorRelativeVopServiceClient::$isRegis){
			
			TmsVendorRelativeVopServiceClient::regis ();
			TmsVendorRelativeVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TmsVendorRelativeVopServiceClient::$DEFAULT_PROXY_IP;
		$port = TmsVendorRelativeVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\tms\chollima\service\vop\TmsVendorRelativeVopServiceHelper();
	}
