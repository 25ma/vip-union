...
class TmsWaybillContractVopServiceClient{
	...
	public static function getService(){
		...
		if (! TmsWaybillContractVopServiceClient::$isRegis){
			
			TmsWaybillContractVopServiceClient::regis ();
			TmsWaybillContractVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TmsWaybillContractVopServiceClient::$DEFAULT_PROXY_IP;
		$port = TmsWaybillContractVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\tms\vop\service\TmsWaybillContractVopServiceHelper();
	}
