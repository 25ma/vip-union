...
class WaybillContractCancelRequest {
	...
	public function getName(){
		...
		return 'WaybillContractCancelRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("request_detail" == $schemeField){
				...
				$this->request_detail = new \com\vip\tms\vop\service\WaybillContractCancelRequestDetail();
