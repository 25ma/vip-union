...
class TmsWaybillVopServiceClient{
	...
	public static function getService(){
		...
		if (! TmsWaybillVopServiceClient::$isRegis){
			
			TmsWaybillVopServiceClient::regis ();
			TmsWaybillVopServiceClient::$isRegis = true;
		}
		
		
		$ctx = \Osp\Context\InvocationContextFactory::getInstance ();
		$ip = TmsWaybillVopServiceClient::$DEFAULT_PROXY_IP;
		$port = TmsWaybillVopServiceClient::$DEFAULT_PROXY_PORT;	
		try{
		...
		return new \com\vip\tms\vop\service\TmsWaybillVopServiceHelper();
	}
