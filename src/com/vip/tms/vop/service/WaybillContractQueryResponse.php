...
class WaybillContractQueryResponse {
	...
	public function getName(){
		...
		return 'WaybillContractQueryResponse';
	}
			...
			if ("response_detail_list" == $schemeField){
				...
				while(true){
					...
					try{
						...
						$elem1 = new \com\vip\tms\vop\service\WaybillContractQueryResponseDetail();
						$elem1->read($input);
						
						$this->response_detail_list[$_size1++] = $elem1;
					}
					catch(\Exception $e){
