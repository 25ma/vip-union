...
class WaybillContractFeedbackRequest {
	...
	public function getName(){
		...
		return 'WaybillContractFeedbackRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("request_detail" == $schemeField){
				...
				$this->request_detail = new \com\vip\tms\vop\service\WaybillContractFeedbackRequestDetail();
