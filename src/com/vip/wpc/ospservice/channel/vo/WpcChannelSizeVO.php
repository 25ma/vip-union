...
class WpcChannelSizeVO {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['limitBuyFlag'])){
				
				$this->limitBuyFlag = $vals['limitBuyFlag'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("limitBuyFlag" == $schemeField){
				
				$needSkip = false;
				$input->readBool($this->limitBuyFlag);
	...
	public function write($output){
		...
		if($this->limitBuyFlag !== null) {
			
			$xfer += $output->writeFieldBegin('limitBuyFlag');
			$xfer += $output->writeBool($this->limitBuyFlag);
