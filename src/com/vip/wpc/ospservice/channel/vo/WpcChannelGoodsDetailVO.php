...
class WpcChannelGoodsDetailVO {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['vendorSn'])){
				
				$this->vendorSn = $vals['vendorSn'];
			}
			
			
			if (isset($vals['goodsBrandId'])){
				
				$this->goodsBrandId = $vals['goodsBrandId'];
			}
			...
			if (isset($vals['isSupportReturn'])){
				
				$this->isSupportReturn = $vals['isSupportReturn'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("vendorSn" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->vendorSn);
			...
			if ("goodsBrandId" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->goodsBrandId);
			...
			if ("isSupportReturn" == $schemeField){
				
				$needSkip = false;
				$input->readBool($this->isSupportReturn);
	...
	public function write($output){
		...
		if($this->vendorSn !== null) {
			
			$xfer += $output->writeFieldBegin('vendorSn');
			$xfer += $output->writeString($this->vendorSn);
		...
		if($this->goodsBrandId !== null) {
			...
			$xfer += $output->writeFieldBegin('goodsBrandId');
			$xfer += $output->writeString($this->goodsBrandId);
		...
		if($this->isSupportReturn !== null) {
			
			$xfer += $output->writeFieldBegin('isSupportReturn');
			$xfer += $output->writeBool($this->isSupportReturn);
