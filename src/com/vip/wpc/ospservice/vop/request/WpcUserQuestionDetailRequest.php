...
class WpcUserQuestionDetailRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['questionsId'])){
				
				$this->questionsId = $vals['questionsId'];
			}
	...
	public function getName(){
		...
		return 'WpcUserQuestionDetailRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("questionsId" == $schemeField){
				
				$needSkip = false;
				$input->readI64($this->questionsId); 
	...
	public function write($output){
		...
		if($this->questionsId !== null) {
			...
			$xfer += $output->writeFieldBegin('questionsId');
			$xfer += $output->writeI64($this->questionsId);
