...
class WpcVopMultiAfterSaleAgainUpdateRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['uploadGoodsList'])){
				
				$this->uploadGoodsList = $vals['uploadGoodsList'];
			}
	...
	public function getName(){
		...
		return 'WpcVopMultiAfterSaleAgainUpdateRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("uploadGoodsList" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->uploadGoodsList);
	...
	public function write($output){
		...
		if($this->uploadGoodsList !== null) {
			
			$xfer += $output->writeFieldBegin('uploadGoodsList');
			$xfer += $output->writeString($this->uploadGoodsList);
