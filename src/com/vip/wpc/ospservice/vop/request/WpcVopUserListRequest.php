...
class WpcVopUserListRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['channelUserIds'])){
				
				$this->channelUserIds = $vals['channelUserIds'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("channelUserIds" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->channelUserIds);
	...
	public function write($output){
		...
		if($this->channelUserIds !== null) {
			...
			$xfer += $output->writeFieldBegin('channelUserIds');
			$xfer += $output->writeString($this->channelUserIds);
