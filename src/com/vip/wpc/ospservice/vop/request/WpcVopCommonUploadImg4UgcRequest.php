...
class WpcVopCommonUploadImg4UgcRequest {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['imageBase64String'])){
				
				$this->imageBase64String = $vals['imageBase64String'];
			}
	...
	public function getName(){
		...
		return 'WpcVopCommonUploadImg4UgcRequest';
	}
	...
	public function read($input){
		...
		while(true){
			...
			if ("imageBase64String" == $schemeField){
				
				$needSkip = false;
				$input->readString($this->imageBase64String);
	...
	public function write($output){
		...
		if($this->imageBase64String !== null) {
			...
			$xfer += $output->writeFieldBegin('imageBase64String');
			$xfer += $output->writeString($this->imageBase64String);
